...
\restrict ZDAAubdiIQVpLGU29vyYMKvfwQSElxab0uiRP6KPcPssZmHuepDpxCwjXGJYO8I
...
ALTER TABLE IF EXISTS ONLY "public"."PushSubscription" DROP CONSTRAINT IF EXISTS "PushSubscription_clientId_fkey";
...
CREATE TABLE "public"."Chat" (
    ...
    "disabledDueToLimit" boolean DEFAULT false NOT NULL
);
...
CREATE TABLE "public"."Client" (
    ...
    "messageLimit" integer DEFAULT 1000,
    "subscriptionResetDay" integer DEFAULT 1 NOT NULL,
    "avatarUrl" "text"
);
...
CREATE TABLE "public"."PushSubscription" (
    ...
    "auth" "text" NOT NULL,
    "createdAt" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    "notifyAllMessages" boolean DEFAULT false NOT NULL,
    "notifyHandoffs" boolean DEFAULT true NOT NULL
);
...
cmtc34o1p0002r0ihmo6geaem	cmtc34o1p0001r0ihw4te4lbt	Abita Bot	\N	t	Eres el asistente de soporte experto interno de Abita AI. Tu misión es ayudar a nuestros clientes (los dueños de los proyectos) a entender cómo usar la plataforma, configurar sus propios agentes de IA, y resolver cualquier duda técnica u operativa que tengan sobre Abita.	1. Responde siempre con tono amigable, profesional y tecnológico.\n2. Eres un experto en Abita AI, una plataforma SaaS que permite a negocios automatizar su atención al cliente por WhatsApp usando IA (Claude/Gemini).\n3. Si el usuario te pregunta cómo hacer algo, dale instrucciones claras paso a paso indicando los módulos del menú lateral (Bandeja, Aprendizaje, Archivos, Campañas, etc.).\n4. Si no sabes la respuesta exacta, o si el cliente reporta un error grave (bug), discúlpate y ofrécele hacer un HANDOFF (transferirlo con un asesor humano de soporte de Abita).\n5. Usa emojis moderadamente para dar un trato cálido. Solo cuando sea necesario. \n6. Nunca hables de temas que no tengan relación con el soporte técnico o uso de Abita AI.	{\n  "plataforma": "Abita AI",\n  "modulos": [\n    {\n      "nombre": "Bandeja (Inbox)",\n      "descripcion": "Es donde el cliente ve los chats de WhatsApp con sus propios clientes.",\n      "funcionalidades": [\n        "Switch 'IA' arriba a la derecha del chat para apagar o encender el bot para ese contacto específico.",\n        "Al apagar el bot, el humano (el cliente) toma el control y puede escribir mensajes manualmente o mandar imágenes.",\n        "Se puede archivar un chat (icono de basurero/archivo).",\n        "Se puede iniciar un nuevo chat presionando el icono '+' y usando una plantilla (template) aprobada.",\n        "En el perfil del usuario se puede encender o apagar el switch de 'Auto-Wake' (reactivar IA automáticamente después de cierto tiempo, configurable en Configuraciones -> Asistente de IA -> Reactivación Automática)."\n      ],\n      "reglas": [\n        "Si un cliente no ha enviado ningún mensaje en las últimas 24h, no se le puede enviar mensaje libre, solo template (política de Meta)."\n      ]\n    },\n    {\n      "nombre": "Aprendizaje (Learning)",\n      "descripcion": "Aquí es donde el cliente entrena a su propia IA.",\n      "funcionalidades": [\n        "Sección de 'Preguntas sin responder' donde aparecen las cosas que la IA no supo contestar para que el cliente pueda entrenarla con respuestas oficiales."\n      ]\n    },\n    {\n      "nombre": "Archivos (Files)",\n      "descripcion": "Permite subir documentos (PDFs, Imágenes, Menús).",\n      "funcionalidades": [\n        "La IA puede leer estos archivos.",\n        "Puede enviarlos a los clientes de forma automática si la situación lo requiere (configurable).",\n        "Se le agrega la instrucción de cuándo tiene que mandar el archivo."\n      ]\n    },\n    {\n      "nombre": "Campañas (Campaigns)",\n      "descripcion": "Sirve para envíos masivos de mensajes promocionales a la base de contactos (leads).",\n      "funcionalidades": [\n        "Para enviar una campaña, se debe seleccionar un Template (Plantilla) previamente aprobado por Meta."\n      ],\n      "precios": {\n        "detalle": "Meta cobra dependiendo de qué tipo de template sea.",\n        "referencia": "https://whatsappbusiness.com/products/platform-pricing/"\n      }\n    },\n    {\n      "nombre": "Templates (Plantillas)",\n      "descripcion": "Muestra las plantillas de WhatsApp aprobadas por Meta que se pueden usar para iniciar chats proactivamente o enviar campañas masivas.",\n      "funcionalidades": [\n        "Se pueden crear nuevas plantillas, las cuales se envían directamente a Meta para su validación.",\n        "Se puede borrar plantillas."\n      ]\n    },\n    {\n      "nombre": "Analíticas (Dashboard)",\n      "descripcion": "Visualización de métricas generales.",\n      "metricas": [\n        "Total de mensajes de IA",\n        "Mensajes manuales",\n        "Dinero estimado gastado",\n        "Handoffs (transferencias)",\n        "Cantidad de leads fríos/calientes"\n      ]\n    },\n    {\n      "nombre": "Leads (Contactos)",\n      "descripcion": "Una tabla CRM con todos los contactos del cliente.",\n      "funcionalidades": [\n        "Muestra el 'Score' (puntaje de interés) y el estado térmico (Frío, Tibio, Caliente).",\n        "La IA puede actualizar correos y nombres automáticamente en esta tabla.",\n        "Muestra un pequeño resumen de la conversación."\n      ]\n    },\n    {\n      "nombre": "Simulador (Test Chat)",\n      "descripcion": "Interfaz para que el cliente pruebe a su propia IA antes de usarla en producción con números de WhatsApp reales.",\n      "reglas": [\n        "Los mensajes enviados aquí no consumen saldo de WhatsApp.",\n        "No cuentan los mensajes para el límite de mensajes al mes."\n      ]\n    },\n    {\n      "nombre": "Configuración (Settings)",\n      "descripcion": "Se divide en varias pestañas.",\n      "pestañas": [\n        {\n          "nombre": "Perfil",\n          "funcionalidades": [\n            "Cambiar contraseña, nombre y foto de perfil.",\n            "Sincronizar información directamente con Meta para traer el nombre y la foto de Meta.",\n            "Borrar el usuario (se borra toda la información).",\n            "Exportar la información actual."\n          ]\n        },\n        {\n          "nombre": "Notificaciones",\n          "funcionalidades": [\n            "Habilitar notificaciones por correo.",\n            "Habilitar notificaciones por mensajes de WhatsApp (requiere que Meta acepte un template que se crea automáticamente en la cuenta).",\n            "Habilitar push notifications al dispositivo (se puede escoger notificar solo handoffs o todos los mensajes)."\n          ]\n        },\n        {\n          "nombre": "Conexiones",\n          "funcionalidades": [\n            "Conectar Abita con Meta."\n          ]\n        },\n        {\n          "nombre": "Herramientas",\n          "funcionalidades": [\n            "Conectar Google Calendar (puede preguntar horarios, crear eventos, editar eventos o borrarlos).",\n            "Conectar Google Sheets (puede preguntar sobre bases de datos, estados de pedidos, o cualquier información en la base de datos) para que el bot pueda hacer consultas."\n          ]\n        },\n        {\n          "nombre": "Asistente AI",\n          "funcionalidades": [\n            {\n              "opcion": "Responder automáticamente",\n              "descripcion": "Si se activa, el bot contestará a los clientes que escriban por primera vez. Si se apaga, todos los mensajes nuevos requerirán atención humana y la IA no enviará respuestas automáticas."\n            },\n            {\n              "opcion": "Reactivación Automática (Auto-Wake)",\n              "descripcion": "Si un humano apaga el bot para tomar una conversación, se reactiva automáticamente el bot tras un periodo de inactividad configurable por el usuario."\n            }\n          ]\n        }\n      ]\n    }\n  ],\n  "datos_extra": {\n    "cambio_de_contraseña": "Se hace desde 'Configuración' -> 'Mi Perfil'.",\n    "modelo_de_cobro": [\n      "Cobro por tokens (uso de IA).",\n      "Cobro por conversaciones (cobros oficiales de Meta)."\n    ]\n  }\n}	MÓDULOS DE LA PLATAFORMA ABITA AI:\n\n1. Bandeja (Inbox):\n- Es donde el cliente ve los chats de WhatsApp con sus propios clientes.\n- Arriba a la derecha del chat hay un switch ("IA") para apagar o encender el bot para ese contacto específico.\n- Al apagar el bot, el humano (el cliente) toma el control y puede escribir mensajes manualmente o mandar imágenes.\n- Se puede archivar un chat (icono de basurero/archivo).\n- Se puede iniciar un nuevo chat presionando el icono '+' y usando una plantilla (template) aprobada.\n- Si un cliente no ha enviado ningun mensaje en las ultimas 24h no podremos enviarle mensaje libre. solo template. (Esto es por politicas de Meta)\n- En el perfil del usuario se puede encender o apagar el switch de encender auto reactivar AI. Esto es para volver a activar el AI despues de cierto tiempo (se configura en configuraciones -> Asistente de IA -> Reactivación Automática (Auto-Wake)Reactivación Automática (Auto-Wake)\n\n2. Aprendizaje (Learning):\n- Aquí es donde el cliente entrena a su propia IA.\n- Esto es una ssección de "Preguntas sin responder" donde aparecen las cosas que la IA no supo contestar para que el cliente pueda entrenarla con respuestas oficiales.\n\n3. Archivos (Files):\n- Permite subir documentos (PDFs, Imágenes, Menús).\n- La IA puede leer estos archivos y, si se le configura, puede enviarlos a los clientes de forma automática si la situación lo requiere.\n- Se le agrega la instruccion de cuando tiene que mandar el archivo.\n\n4. Campañas (Campaigns):\n- Sirve para envíos masivos de mensajes promocionales a la base de contactos (leads).\n- Para enviar una campaña, se debe seleccionar un Template (Plantilla) previamente aprobado por Meta.\n- Meta cobra dependiendo de que tipo de templete sea. Pueden leer mas en: https://whatsappbusiness.com/products/platform-pricing/\n\n5. Templates (Plantillas):\n- Muestra las plantillas de WhatsApp aprobadas por Meta que se pueden usar para iniciar chats proactivamente o enviar campañas masivas.\n- Pueden crear nuevas plantillas y se envian directamente a que Meta las valide.\n- Se puede borrar plantillas.\n\n6. Analíticas (Dashboard):\n- Visualización de métricas generales: total de mensajes de IA, mensajes manuales, dinero estimado gastado, handoffs (transferencias) y cantidad de leads fríos/calientes.\n\n7. Leads (Contactos):\n- Una tabla CRM con todos los contactos del cliente.\n- Muestra el 'Score' (puntaje de interés) y el estado térmico (Frío, Tibio, Caliente).\n- La IA puede actualizar correos y nombres automáticamente en esta tabla.\n- Muestra un pequeño resumen de la conversacion.\n\n8. Simulador (Test Chat):\n- Interfaz para que el cliente pruebe a su propia IA antes de usarla en producción con números de WhatsApp reales. Los mensajes que se envian por aca no consume saldo de whatsapp, ni tampoco cuentan los mensajes para el limmite de mensajes al mes.\n\n9. Configuración (Settings):\n- Se divide en varias pestañas: \n- Perfil: Puedes cambiar tu contraseña, nombre, y foto de perfil o sincronizar esta informacion directamente con Meta para que traiga el nombre y la foto que tienes en Meta. Igual puedes borrar tu usuario (se borra toda la informamcion) o exportar la info actual.\n- Notificaciones: Puedes habilitar notificaciones por medio de correo, mensajes de whatsapp (Meta tiene que aceptarte un template que se crea automaticamente en tu cuenta), o push notifications a tu dispositivo (para este puedes escoger si solo quieres que te notifiquen los handoffs o todos los mensajes que te caen.\n- Conexiones: Aca es adonde conectas Abita con tu Meta.\nHerramientas: Puedes conectar tu Google Calendar (puede preguntar horarios, crear eventos, editar eventos, o borrarlos) o Google Sheets (Puede preguntar sobre tus bases de datos sobre estados de pedidos, o cualquier informacion en tu base de datos) para que tu bot pueda hacer consultas.\n- Asistente AI: Responder automáticamente (Si activas esta opción, el bot contestará a los clientes que te escriban por primera vez. Si la apagas, todos los mensajes nuevos requerirán atención humana y la IA no enviará respuestas automáticas), Reactivación Automática (Auto-Wake) (Si un humano apaga el bot para tomar una conversación, reactivar automáticamente el bot tras un periodo de inactividad. Tu escoges el tiempo)\n\nDATOS EXTRA:\n- Para cambiar la contraseña: Se hace desde 'Configuración' -> 'Mi Perfil'.\n- La plataforma cobra por tokens (uso de IA) y por conversaciones (cobros oficiales de Meta).\n\n	P: ¿Dónde cambio mi contraseña o mis datos de perfil?\nR: Puedes cambiar tu contraseña en el módulo de "Configuración" (Settings) y luego ir a la pestaña "Mi Perfil". También puedes acceder haciendo clic en tu foto en la esquina inferior izquierda del menú.\n\nP: Mi IA no responde en WhatsApp, ¿qué pasa?\nR: Revisa dos cosas importantes: 1) Que la IA esté encendida para ese chat (en la Bandeja), y 2) Que tu "WhatsApp Token" y "Phone Number ID" estén correctamente ingresados en el módulo de Configuración -> WhatsApp.\n\nP: ¿Cómo hago para que la IA le pase un cliente a un humano?\nR: En el módulo de "Aprendizaje", ve a la sección "Reglas de Handoff" e instruye a la IA bajo qué condiciones debe transferir la conversación (por ejemplo: "Si te piden hablar con un agente, haz handoff"). Cuando suceda, el chat se pondrá rojo en tu Bandeja.\n\nP: ¿Cómo cobro a mis clientes o envío links de pago?\nR: Puedes instruir a tu IA en el módulo de Aprendizaje para que entregue los links de pago (ej. Wompi, Stripe o link de banco) cuando el cliente lo solicite.\n\nP: ¿Tienen app móvil?\nR: Abita AI es 100% responsivo, por lo que puedes abrirlo en el navegador de tu celular y usar la plataforma como si fuera una aplicación móvil.	[]	Si el usuario pregunta algo que no sabes, reporta un error en la plataforma, o te pide explícitamente hablar con soporte humano (un asesor real), debes transferirlo.
\.
...
cmtbvzrid0001d5ca3qy2igl7	cmsqwg29d0000m4q8tyw8g0p1	PROFILE_UPDATED	Nombre/Correo actualizado a Hera1 / hera@abitaai.com	server-action	2026-08-27 18:59:22.497
cmtbvzvrc0003d5ca6cfuo9jw	cmsqwg29d0000m4q8tyw8g0p1	PROFILE_UPDATED	Nombre/Correo actualizado a Hera / hera@abitaai.com	server-action	2026-08-27 18:59:28.008
\.
...
cmss0yf5t000ein22dy0q6svh	cmsrzknn30003in22zrate8g2	{nombre_cliente}	{{nombre_cliente}}**		60	¡Listo! Su cita ha sido agendada para el {{fecha}} a las {{hora_inicio}}.	2026-08-13 21:22:54.401	2026-08-21 21:26:21.704	{daniel.alas1609@gmail.com,3a96d6cba212184cf39d4238734d938640689cc12b7340e6f76ed1ced6fb5a46@group.calendar.google.com}	1
\.
...
COPY "public"."Chat" ("id", "leadId", "botActive", "lastActiveAt", "createdAt", "isArchived", "channel", "autoWakeBot", "disabledDueToLimit") FROM stdin;
cmsr0vpra0005audyoizhzczg	cmsr0vop20003audy34afpys2	f	2026-08-13 04:33:01.99	2026-08-13 04:33:01.99	f	whatsapp	f	f
cmsr0vzaf000haudywyi7qswu	cmsr0vyj5000faudyfwvgyant	f	2026-08-13 04:33:14.343	2026-08-13 04:33:14.343	f	whatsapp	f	f
cmsr13qxv009taudy5gyddt9f	cmsr13q2k009raudyi0xw6zrb	f	2026-08-13 04:39:16.771	2026-08-13 04:39:16.771	f	whatsapp	f	f
cmsr0lqrp003zc3we6y5yoalh	cmsr0lq3p003xc3wezfm4rntb	f	2026-08-13 04:25:16.741	2026-08-13 04:25:16.741	f	whatsapp	f	f
cmsr0lv4a0045c3weqtmjppkp	cmsr0lu810043c3webehbml1a	f	2026-08-13 04:25:22.379	2026-08-13 04:25:22.379	f	whatsapp	f	f
cmsr0inpq0005c3weu55qbxlp	cmsr0impf0003c3webjfj581d	f	2026-08-13 04:22:52.814	2026-08-13 04:22:52.814	f	whatsapp	f	f
cmsr0itde000bc3wesx8g6lwa	cmsr0iskz0009c3we7gtf8esv	f	2026-08-13 04:23:00.147	2026-08-13 04:23:00.147	f	whatsapp	f	f
cmsr0iz7z000hc3web6lihq93	cmsr0iy49000fc3we6sqfwdlt	f	2026-08-13 04:23:07.727	2026-08-13 04:23:07.727	f	whatsapp	f	f
cmsr0j3vr000nc3weauvt485m	cmsr0j32v000lc3webk5acn36	f	2026-08-13 04:23:13.767	2026-08-13 04:23:13.767	f	whatsapp	f	f
cmsr0ja77000tc3wey9oeqzbn	cmsr0j9dy000rc3we92g1j36o	f	2026-08-13 04:23:21.955	2026-08-13 04:23:21.955	f	whatsapp	f	f
cmstfhrba0003r8yu0407koh5	cmstfhqmq0001r8yuwimjeeho	t	2026-09-01 18:01:00.775	2026-08-14 20:57:37.415	f	whatsapp	t	f
cmsr0jfh6000zc3we5m74r4eu	cmsr0jega000xc3wej1cgjcqs	f	2026-08-13 04:23:28.794	2026-08-13 04:23:28.794	f	whatsapp	f	f
cmsr0jjrj0015c3we5d9t5ni9	cmsr0jj7p0013c3weh0rcvyut	f	2026-08-13 04:23:34.351	2026-08-13 04:23:34.351	f	whatsapp	f	f
cmsr0jow5001bc3wezhoistvp	cmsr0jnzb0019c3wevpultl9d	f	2026-08-13 04:23:40.997	2026-08-13 04:23:40.997	f	whatsapp	f	f
cmsr0jtuv001hc3wesuklemqo	cmsr0jswv001fc3wex8pxumah	f	2026-08-13 04:23:47.431	2026-08-13 04:23:47.431	f	whatsapp	f	f
cmsr0jzhd001nc3webzkgkpc3	cmsr0jyjq001lc3weji9fcn54	f	2026-08-13 04:23:54.722	2026-08-13 04:23:54.722	f	whatsapp	f	f
cmsr0k43t001tc3wefmypsrq7	cmsr0k39v001rc3we62dnuxdk	f	2026-08-13 04:24:00.713	2026-08-13 04:24:00.713	f	whatsapp	f	f
cmsr0k8ip001zc3we3o0dck1h	cmsr0k7t6001xc3weytl8m5hc	f	2026-08-13 04:24:06.433	2026-08-13 04:24:06.433	f	whatsapp	f	f
cmsr0w4ki000naudyoy0qlt4i	cmsr0w3p7000laudy83o332b2	f	2026-08-13 04:33:21.186	2026-08-13 04:33:21.186	f	whatsapp	f	f
cmsr0wf0g000zaudy33334bwa	cmsr0wedj000xaudyltwfu58h	f	2026-08-13 04:33:34.72	2026-08-13 04:33:34.72	f	whatsapp	f	f
cmsr0wk0r0015audy5xfg21h6	cmsr0wj860013audyoyw5x345	f	2026-08-13 04:33:41.211	2026-08-13 04:33:41.211	f	whatsapp	f	f
cmsr0wp1b001baudy40on20zr	cmsr0wo4l0019audylb1gbqeb	f	2026-08-13 04:33:47.711	2026-08-13 04:33:47.711	f	whatsapp	f	f
cmsr0wud9001haudyt3elwuzt	cmsr0wtkx001faudyh88i8113	f	2026-08-13 04:33:54.621	2026-08-13 04:33:54.621	f	whatsapp	f	f
cmsr0xkfy002daudy556y1amj	cmsr0xjhx002baudy8j8xisp8	f	2026-08-13 04:34:28.048	2026-08-13 04:34:28.048	f	whatsapp	f	f
cmsr0xqda002jaudy2vk25hhq	cmsr0xp6m002haudywi0tc8c2	f	2026-08-13 04:34:36.094	2026-08-13 04:34:36.094	f	whatsapp	f	f
cmsr0xx2z002paudyi26yp00c	cmsr0xvsc002naudycbhm8pk4	f	2026-08-13 04:34:44.492	2026-08-13 04:34:44.492	f	whatsapp	f	f
cmsr0y8b00031audy0yi5urvn	cmsr0y7dt002zaudyiuftuh9q	f	2026-08-13 04:34:59.34	2026-08-13 04:34:59.34	f	whatsapp	f	f
cmsr0yn02003jaudy5w3i78mj	cmsr0ym2j003haudy03i2a17o	f	2026-08-13 04:35:18.386	2026-08-13 04:35:18.386	f	whatsapp	f	f
cmsr0z24o0041audylhlk93wx	cmsr0z0z9003zaudyx3co6w7o	f	2026-08-13 04:35:37.993	2026-08-13 04:35:37.993	f	whatsapp	f	f
cmsr0z7850047audylqs9ee4c	cmsr0z6cw0045audyq9mlzaew	f	2026-08-13 04:35:44.597	2026-08-13 04:35:44.597	f	whatsapp	f	f
cmsr0zctt004daudyeot5c9n8	cmsr0zc2h004baudylr22y6df	f	2026-08-13 04:35:51.857	2026-08-13 04:35:51.857	f	whatsapp	f	f
cmsr103ta005baudy7q9mh5sr	cmsr102zp0059audyznfh3xgn	f	2026-08-13 04:36:26.83	2026-08-13 04:36:26.83	f	whatsapp	f	f
cmsr108ya005haudy52mkxuz3	cmsr1084h005faudyejg1r0ek	f	2026-08-13 04:36:33.49	2026-08-13 04:36:33.49	f	whatsapp	f	f
cmsr118mo006naudyijbqcz5x	cmsr117oj006laudyfrylmcox	f	2026-08-13 04:37:19.728	2026-08-13 04:37:19.728	f	whatsapp	f	f
cmsr11dt2006taudyoa3n9bos	cmsr11d3i006raudysylcgkyb	f	2026-08-13 04:37:26.438	2026-08-13 04:37:26.438	f	whatsapp	f	f
cmsr11i9p006zaudy2na1yalg	cmsr11hmy006xaudyydagc69j	f	2026-08-13 04:37:32.221	2026-08-13 04:37:32.221	f	whatsapp	f	f
cmsr11n8b0075audyofk3h1kd	cmsr11m640073audyrp014p2m	f	2026-08-13 04:37:38.504	2026-08-13 04:37:38.504	f	whatsapp	f	f
cmsr11suu007baudyzi3nvayv	cmsr11rzn0079audy053xzmy2	f	2026-08-13 04:37:45.942	2026-08-13 04:37:45.942	f	whatsapp	f	f
cmsr11zev007haudy3kyksx34	cmsr11yu2007faudyj7sjt6dz	f	2026-08-13 04:37:54.439	2026-08-13 04:37:54.439	f	whatsapp	f	f
cmsr0kd1c0025c3weg74t8d7w	cmsr0kc570023c3wel87lnkkr	f	2026-08-13 04:24:12.289	2026-08-13 04:24:12.289	f	whatsapp	f	f
cmsr0khod002bc3weik3ecftj	cmsr0kgsd0029c3werjjuzxhh	f	2026-08-13 04:24:18.301	2026-08-13 04:24:18.301	f	whatsapp	f	f
cmsr0km5r002hc3wem4ic8wv5	cmsr0kl7i002fc3wezjyyqbxr	f	2026-08-13 04:24:23.948	2026-08-13 04:24:23.948	f	whatsapp	f	f
cmsr0kqyi002nc3weomv6ly70	cmsr0kqbf002lc3we7350tv7j	f	2026-08-13 04:24:30.33	2026-08-13 04:24:30.33	f	whatsapp	f	f
cmsr0kv8u002tc3we299tlfex	cmsr0kufi002rc3wegx9z54na	f	2026-08-13 04:24:35.886	2026-08-13 04:24:35.886	f	whatsapp	f	f
cmsr0kzwo002zc3weygucn38x	cmsr0kz3g002xc3weduv7ljpf	f	2026-08-13 04:24:41.928	2026-08-13 04:24:41.928	f	whatsapp	f	f
cmsr0l4jv0035c3we4kmaenpx	cmsr0l3pj0033c3we94so5zg6	f	2026-08-13 04:24:47.947	2026-08-13 04:24:47.947	f	whatsapp	f	f
cmsr0l8rg003bc3wem3mccnvw	cmsr0l7w10039c3we9dkw30n7	f	2026-08-13 04:24:53.404	2026-08-13 04:24:53.404	f	whatsapp	f	f
cmsr0lhoq003nc3wewi7u4iev	cmsr0lguc003lc3we4d1shpyf	f	2026-08-13 04:25:04.97	2026-08-13 04:25:04.97	f	whatsapp	f	f
cmsr0llot003tc3welv6bkg80	cmsr0ll3q003rc3we6z4mdw9g	f	2026-08-27 22:58:15.594	2026-08-13 04:25:10.157	f	whatsapp	f	f
cmsr1240w007naudytcxdodlr	cmsr123c9007laudy0m20dtq0	f	2026-08-13 04:38:00.416	2026-08-13 04:38:00.416	f	whatsapp	f	f
cmsr128u3007taudyvge64wx6	cmsr127wu007raudyyd3m59tq	f	2026-08-13 04:38:06.652	2026-08-13 04:38:06.652	f	whatsapp	f	f
cmsr12cva007zaudyugvsy8cy	cmsr12c7r007xaudyfm3z9yg1	f	2026-08-13 04:38:11.878	2026-08-13 04:38:11.878	f	whatsapp	f	f
cmsr12h9z0085audyowb5hrp2	cmsr12gah0083audyligdmii4	f	2026-08-13 04:38:17.591	2026-08-13 04:38:17.591	f	whatsapp	f	f
cmsr12qgc008haudyvd8de0ix	cmsr12pbz008faudywqrog9lf	f	2026-08-13 04:38:29.484	2026-08-13 04:38:29.484	f	whatsapp	f	f
cmsr12uyf008naudyezba1zki	cmsr12u4o008laudyzo2qg2xe	f	2026-08-13 04:38:35.319	2026-08-13 04:38:35.319	f	whatsapp	f	f
cmsr12zu8008taudyt9u6kzm0	cmsr12yzr008raudyhklvyqts	f	2026-08-13 04:38:41.649	2026-08-13 04:38:41.649	f	whatsapp	f	f
cmsr13dt7009baudyo5bjewhn	cmsr13d7w0099audy0cuyyr4c	f	2026-08-13 04:38:59.755	2026-08-13 04:38:59.755	f	whatsapp	f	f
cmsr13i1h009haudyrn6ce110	cmsr13hac009faudy36kh3d0r	f	2026-08-13 04:39:05.238	2026-08-13 04:39:05.238	f	whatsapp	f	f
cmsr2d6ah000im4q8ti8d637d	cmsr2d6ah000hm4q8loklx1wd	t	2026-08-13 05:14:36.185	2026-08-13 05:14:36.185	f	simulator	t	f
cmsqzz9750013j7k6iwtfw7z4	cmsqzxikm000110oqs1g3goy3	f	2026-08-27 19:01:40.321	2026-08-13 04:07:47.537	t	whatsapp	f	f
cmsr0ywin003vaudy2s4hfh0r	cmsr0yvo6003taudyavk7f83i	f	2026-08-13 22:46:46.291	2026-08-13 04:35:30.719	f	whatsapp	f	f
cmsr10ex6005naudyvqyzej2u	cmsr10dnp005laudy781l1iu2	f	2026-08-18 03:05:59.601	2026-08-13 04:36:41.227	f	whatsapp	f	f
cmsr0zhi2004jaudy8zs9vu4e	cmsr0zgpi004haudyi60lwr0h	f	2026-08-17 19:55:47.675	2026-08-13 04:35:57.915	f	whatsapp	f	f
cmsqx4ls80003j7k6lj5an1j4	cmsqx4l370001j7k64jlcpz3v	t	2026-08-24 19:39:08.286	2026-08-13 02:47:58.28	f	whatsapp	t	f
cmt0wnzuo0003fvxolbh3vdrd	cmt0wnz5j0001fvxonsvb9eog	t	2026-08-20 02:33:41.922	2026-08-20 02:32:45.12	f	whatsapp	t	f
cmsr2ejjx0006fsu7i0dcrpzu	cmsr2ejjx0005fsu7mbrbqjxa	t	2026-08-13 05:15:40.028	2026-08-13 05:15:40.028	f	simulator	t	f
cmsr0ldea003hc3wepvvjgoj7	cmsr0lcv4003fc3webyf8wqrf	f	2026-08-28 02:12:39.404	2026-08-13 04:24:59.41	f	whatsapp	f	f
cmtc3mxrw0002joo3ct17d1us	cmtc3mxrw0001joo38fisswwf	t	2026-08-27 22:41:17.97	2026-08-27 22:33:21.017	f	abita_bot	t	f
cmsr0vv8f000baudywofmqqol	cmsr0vuiq0009audywa6xzcdi	f	2026-08-13 04:33:09.087	2026-08-13 04:33:09.087	f	whatsapp	f	f
cmsr0wa7z000taudyj025x9vj	cmsr0w9cu000raudyqvrd4pnt	f	2026-08-13 04:33:28.512	2026-08-13 04:33:28.512	f	whatsapp	f	f
cmsr0x039001paudyiqxfv5im	cmsr0wzdt001naudy2yp1mz3c	f	2026-08-13 04:34:02.037	2026-08-13 04:34:02.037	f	whatsapp	f	f
cmsr0x4xr001vaudyofiyq0q1	cmsr0x438001taudyseh7upso	f	2026-08-13 04:34:08.319	2026-08-13 04:34:08.319	f	whatsapp	f	f
cmsr0xa6m0021audyy8tbxqsl	cmsr0x954001zaudyzaouaz2k	f	2026-08-13 04:34:15.118	2026-08-13 04:34:15.118	f	whatsapp	f	f
cmsr0xf5c0027audy6gnyaqpv	cmsr0xeij0025audyuj9t65oz	f	2026-08-13 04:34:21.552	2026-08-13 04:34:21.552	f	whatsapp	f	f
cmsr0y2rw002vaudyzmsx8jpx	cmsr0y1x0002taudy907svv9a	f	2026-08-13 04:34:52.173	2026-08-13 04:34:52.173	f	whatsapp	f	f
cmsr0ydic0037audy2yqsba5g	cmsr0ycmj0035audylfunfszy	f	2026-08-13 04:35:06.084	2026-08-13 04:35:06.084	f	whatsapp	f	f
cmsr0yi4h003daudylh2pb0yv	cmsr0yhb7003baudy5gi9ydn1	f	2026-08-13 04:35:12.065	2026-08-13 04:35:12.065	f	whatsapp	f	f
cmsr0ys0k003paudyl3p6moxs	cmsr0yr9l003naudybr7o92xj	f	2026-08-13 04:35:24.884	2026-08-13 04:35:24.884	f	whatsapp	f	f
cmsr0zn2g004raudyw31yxuyt	cmsr0zm5x004paudyuibfkzqq	f	2026-08-13 04:36:05.128	2026-08-13 04:36:05.128	f	whatsapp	f	f
cmsr0ztdt004zaudywy01t02v	cmsr0zspy004xaudyb0o5x9l2	f	2026-08-13 04:36:13.313	2026-08-13 04:36:13.313	f	whatsapp	f	f
cmsr0zykc0055audyb7t8ijjw	cmsr0zxkg0053audyg1jri57d	f	2026-08-13 04:36:19.824	2026-08-13 04:36:19.824	f	whatsapp	f	f
cmsr10km9005taudyl2u6u86u	cmsr10jth005raudyc53ms6cq	f	2026-08-13 04:36:48.609	2026-08-13 04:36:48.609	f	whatsapp	f	f
cmsr10pie005zaudyf5twy9z6	cmsr10osf005xaudy50rdt9wl	f	2026-08-13 04:36:54.95	2026-08-13 04:36:54.95	f	whatsapp	f	f
cmsr10u4k0065audy5u9tvsp9	cmsr10tb60063audyi4nd4rpn	f	2026-08-13 04:37:00.932	2026-08-13 04:37:00.932	f	whatsapp	f	f
cmsr0m010004bc3welfic2fk0	cmsr0lz2i0049c3wecxl6qjs3	f	2026-08-13 04:25:28.28	2026-08-13 04:25:28.28	f	whatsapp	f	f
cmsr0m4zm004hc3we8vv8q9g0	cmsr0m47a004fc3wefcnn1e73	f	2026-08-13 04:25:35.171	2026-08-13 04:25:35.171	f	whatsapp	f	f
cmsr0maav004nc3wexyo20m31	cmsr0m9d5004lc3we81f2vebw	f	2026-08-13 04:25:42.055	2026-08-13 04:25:42.055	f	whatsapp	f	f
cmt34n8i70004nhqpakyo2hqj	cmt34n7qr0002nhqp76pc1msl	f	2026-08-31 21:31:07.631	2026-08-21 15:51:38.959	f	whatsapp	f	f
cmsr0mjod004zc3welv0bkxvq	cmsr0mii4004xc3wem1g7m2s1	f	2026-08-13 04:25:54.205	2026-08-13 04:25:54.205	f	whatsapp	f	f
cmsr0mont0055c3wecx457ggp	cmsr0mno40053c3we3y3baws0	f	2026-08-13 04:26:00.349	2026-08-13 04:26:00.349	f	whatsapp	f	f
cmsr0msd6005bc3we9d30h6kz	cmsr0mrm80059c3we55eurcva	f	2026-08-13 04:26:05.466	2026-08-13 04:26:05.466	f	whatsapp	f	f
cmsr0n124005nc3weqgwo1jpx	cmsr0mzyq005lc3we7xjxxkjs	f	2026-08-13 04:26:16.594	2026-08-13 04:26:16.594	f	whatsapp	f	f
cmsr0n5ta005tc3wetgfkdrwl	cmsr0n51u005rc3wehsl7m40o	f	2026-08-13 04:26:22.894	2026-08-13 04:26:22.894	f	whatsapp	f	f
cmsr0nbcc005zc3wemsygmmau	cmsr0namq005xc3wew7un80vw	f	2026-08-13 04:26:30.06	2026-08-13 04:26:30.06	f	whatsapp	f	f
cmsr0nfq20065c3werxeiz016	cmsr0nf6c0063c3weeq0855x0	f	2026-08-13 04:26:35.739	2026-08-13 04:26:35.739	f	whatsapp	f	f
cmsr0nkto006bc3wekcq4k9gp	cmsr0njpw0069c3weih8r990r	f	2026-08-13 04:26:42.348	2026-08-13 04:26:42.348	f	whatsapp	f	f
cmsr0np3j006hc3we6kof0t8d	cmsr0noa5006fc3wezu47cr0y	f	2026-08-13 04:26:47.747	2026-08-13 04:26:47.747	f	whatsapp	f	f
cmsr0nta1006nc3wefjnnjdul	cmsr0nshq006lc3wenfp1wqw4	f	2026-08-13 04:26:53.305	2026-08-13 04:26:53.305	f	whatsapp	f	f
cmsr10z14006baudycho59qt5	cmsr10y1l0069audykfnkfw2i	f	2026-08-13 04:37:07.135	2026-08-13 04:37:07.135	f	whatsapp	f	f
cmsr113gf006haudyshok647q	cmsr112qb006faudy9z2w5e3b	f	2026-08-13 04:37:13.024	2026-08-13 04:37:13.024	f	whatsapp	f	f
cmsr12luq008baudy2fga2rll	cmsr12kq10089audyikpc086e	f	2026-08-13 04:38:23.326	2026-08-13 04:38:23.326	f	whatsapp	f	f
cmsr134ns008zaudyspekufwk	cmsr133v9008xaudy7laym9hw	f	2026-08-13 04:38:47.896	2026-08-13 04:38:47.896	f	whatsapp	f	f
cmsr139gf0095audy6lx1t829	cmsr138j40093audy7foa7eq8	f	2026-08-13 04:38:53.976	2026-08-13 04:38:53.976	f	whatsapp	f	f
cmsr13ma2009naudyiytmmfr6	cmsr13lo0009laudyqgf9tfdq	f	2026-08-13 04:39:10.73	2026-08-13 04:39:10.73	f	whatsapp	f	f
cmss0yy6i000hin22f8ddugj1	cmss0yy6i000gin22bhmm7clh	t	2026-08-13 21:23:19.051	2026-08-13 21:23:19.051	f	simulator	t	f
cmsuh7h4e0004hisfval9pqxs	cmsuh7gdg0002hisfhw05oq56	f	2026-08-15 14:33:23.588	2026-08-15 14:33:23.054	f	whatsapp	f	f
cmsr0mebc004tc3we1wu3mqy7	cmsr0mdlr004rc3werkgjparh	f	2026-08-20 23:35:06.779	2026-08-13 04:25:47.257	f	whatsapp	f	f
cmtc6k4sc0002ozjwmia4imcp	cmtc6k4sc0001ozjwpy7peimw	t	2026-08-27 23:55:08.987	2026-08-27 23:55:08.987	f	simulator	t	f
cmsr0mw5m005hc3wep30hn0jl	cmsr0mve4005fc3weykioc2sq	f	2026-08-30 22:26:52.577	2026-08-13 04:26:10.378	f	whatsapp	f	f
\.
...
COPY "public"."Client" ("id", "name", "email", "createdAt", "password", "theme", "role", "templateGroup", "subscriptionEndsAt", "subscriptionStatus", "failedLoginAttempts", "messageLimit", "subscriptionResetDay", "avatarUrl") FROM stdin;
cmsqwg29d0000m4q8tyw8g0p1	Hera	hera@abitaai.com	2026-08-13 02:28:52.844	$2b$10$6rCFhhIiO2mq6sIMWxdwZe77aaSRRdz.a6dEgJ6EPwZfBTzj/c6x6	dark	CLIENT		\N	ACTIVE	0	1000	1	https://pps.whatsapp.net/v/t61.24694-24/671955995_3158943900955567_1601128733541440588_n.jpg?ccb=11-4&oh=01_Q5Aa5QHT73BF-sH4BkFLK2qjSwTcDZy3u0eL9QJ_wILVyprX3g&oe=6A947ECF&_nc_sid=5e03e0&_nc_cat=111
cmtc34o1m0000r0ihrddv3b5f	Abita AI Assistant	abita-bot@abitaai.com	2026-08-27 22:19:08.601	$2b$10$E5deZ5n4faKspGNcXbL/oek1/kA.pjUVGu.jeTRYg9edGOuoAlXK2	light	ABITA_BOT	\N	\N	ACTIVE	0	1000	1	\N
cmsrzknn10002in226nff6d48	roofballsv	roofball@abitaai.com	2026-08-13 20:44:12.531	$2b$10$AwPqtZrM28RbHwJ4f0cZ2uKbH5DfPpmm28PMQKzxRD8HuBy/O2ZYu	light	CLIENT		\N	ACTIVE	0	1000	1	https://pps.whatsapp.net/v/t61.24694-24/534427836_2273233143478769_8659674070494446709_n.jpg?ccb=11-4&oh=01_Q5Aa5QGPmZ2ndfiPfH1GFhmCqkr-ukM3z3YOxv81rCSRu28qUw&oe=6A99DEDF&_nc_sid=5e03e0&_nc_cat=107
cmsqw95750000djv19encc7te	Admin Abita	info@abitaai.com	2026-08-13 02:23:30.45	$2b$10$NYhBJFLSm.ZDET0VKYV3OucPZQgy3jubCYJkmQA42dSQJPqQyxX82	dark	ADMIN	\N	\N	ACTIVE	0	1000	1	\N
cmsqww9qj0003m4q8135x6e7z	Melto	melto@abitaai.com	2026-08-13 02:41:29.37	$2b$10$rAc2KL5w5AwQnYMi0wCaUeKTc07Syds3QuaWjoF1dkzHPkHgbwfa6	light	CLIENT		\N	ACTIVE	0	35	1	\N
\.
...
cmsxnpbtr00055m8rtwqr60nl	cmsrzknn10002in226nff6d48	meta_whatsapp	active	\N	\N	\N	\N	\N	\N	2026-08-17 19:58:32.224	2026-08-17 19:58:32.224
\.
...
cmsr0ll3q003rc3we6z4mdw9g	cmsqwg29d0001m4q88md1xvrl	50378504248	Sr. Javier Miguel y Sra.	PENDING	0	FRIO	2026-08-13 04:25:09.398	2026-08-27 22:56:52.381	\N	cmsr0ily90001c3wev58irr2k	cmsqwg29d0002m4q8wkyq226l	{"imported_at": "2026-08-13T04:25:09.397Z"}	whatsapp	\N
...
cmsr0lcv4003fc3webyf8wqrf	cmsqwg29d0001m4q88md1xvrl	50378870042	Sr. Rolando Duarte y Sra.	PENDING	0	FRIO	2026-08-13 04:24:58.72	2026-08-28 02:12:38.69	\N	cmsr0ily90001c3wev58irr2k	cmsqwg29d0002m4q8wkyq226l	{"imported_at": "2026-08-13T04:24:58.719Z"}	whatsapp	\N
...
cmsr0mdlr004rc3werkgjparh	cmsqwg29d0001m4q88md1xvrl	18136060111	Sr. Francisco Giammattei y Sra.	PENDING	0	FRIO	2026-08-13 04:25:46.335	2026-08-20 23:35:06.101	\N	cmsr0ily90001c3wev58irr2k	cmsqwg29d0002m4q8wkyq226l	{"imported_at": "2026-08-13T04:25:46.334Z"}	whatsapp	\N
cmsr0mve4005fc3weykioc2sq	cmsqwg29d0001m4q88md1xvrl	595981400890	Srta. Alejandra Maluff	PENDING	0	FRIO	2026-08-13 04:26:09.388	2026-08-30 22:26:51.872	\N	cmsr0ily90001c3wev58irr2k	cmsqwg29d0002m4q8wkyq226l	{"imported_at": "2026-08-13T04:26:09.388Z"}	whatsapp	\N
...
cmsr0zgpi004haudyi60lwr0h	cmsqwg29d0001m4q88md1xvrl	13057481870	Sr. Roberto Duque y Sra.	IN_PROGRESS	0	FRIO	2026-08-13 04:35:56.886	2026-08-17 19:54:52.246	\N	cmsr0vnzp0001audyne7zyqgs	cmsqwg29d0002m4q8wkyq226l	{"imported_at": "2026-08-13T04:35:56.885Z"}	whatsapp	\N
...
cmsr10dnp005laudy781l1iu2	cmsqwg29d0001m4q88md1xvrl	50375588280	Sr. Mauricio Mena	PENDING	0	FRIO	2026-08-13 04:36:39.589	2026-08-18 03:05:58.893	\N	cmsr0vnzp0001audyne7zyqgs	cmsqwg29d0002m4q8wkyq226l	{"imported_at": "2026-08-13T04:36:39.588Z"}	whatsapp	\N
...
cmstfhqmq0001r8yuwimjeeho	cmsrzknn30003in22zrate8g2	50360545592	Sebastian R	NEEDS_AGENT	0	FRIO	2026-08-14 20:57:36.53	2026-09-01 17:57:49.499	El cliente buscaba reservar una cancha de fútbol para el domingo 16 de agosto a las 12:00 pm y realizar una nueva reserva adicional para el viernes 4 de septiembre, consultando disponibilidad de horarios. La conversación se detuvo en el momento en que el asistente preguntaba qué horario específico prefería el cliente para la reserva del viernes, después de confirmar que todo el día estaba disponible.	\N	cmsrzknn30004in22q8mewvlf	{}	whatsapp	\N
cmt34n7qr0002nhqp76pc1msl	cmsqww9qj0004m4q86g2jpp6a	50375582860	Gabriel Funes	IN_PROGRESS	0	FRIO	2026-08-21 15:51:37.971	2026-08-22 20:20:28.381	\N	\N	cmsqww9qj0005m4q87n2duh4w	{}	whatsapp	\N
...
cmtc3mxrw0001joo38fisswwf	cmtc34o1p0001r0ihw4te4lbt	melto@abitaai.com	Melto	PENDING	0	FRIO	2026-08-27 22:33:21.017	2026-08-27 22:41:19.09	\N	\N	\N	{}	abita_bot	\N
cmt0wnz5j0001fvxonsvb9eog	cmsrzknn30003in22zrate8g2	50377420063	Paulina Frech	NEEDS_AGENT	0	FRIO	2026-08-20 02:32:44.207	2026-08-20 02:33:40.925	\N	\N	cmsrzknn30004in22q8mewvlf	{}	whatsapp	\N
cmsr2ejjx0005fsu7mbrbqjxa	cmsqww9qj0004m4q86g2jpp6a	SIMULADOR_TEST	Usuario de Prueba	PENDING	0	FRIO	2026-08-13 05:15:40.028	2026-08-21 22:18:16.702	\N	\N	\N	{"simulator_session": 1787350696701}	simulator	\N
cmtc6k4sc0001ozjwpy7peimw	cmtc34o1p0001r0ihw4te4lbt	SIMULADOR_TEST	Usuario de Prueba	PENDING	0	FRIO	2026-08-27 23:55:08.987	2026-08-27 23:55:08.987	\N	\N	\N	{}	simulator	\N
cmsqx4l370001j7k64jlcpz3v	cmsqww9qj0004m4q86g2jpp6a	50376003378	DA	IN_PROGRESS	10	FRIO	2026-08-13 02:47:57.379	2026-08-24 02:46:05.83	El cliente buscaba realizar un pedido de sorbete de vainilla y conocer los días y horarios disponibles para recogerlo, deteniéndose la conversación en el momento en que el asistente pregunta si desea agendar el pickup para el sábado.	\N	cmsqww9qj0005m4q87n2duh4w	{}	whatsapp	\N
cmss0yy6i000gin22bhmm7clh	cmsrzknn30003in22zrate8g2	SIMULADOR_TEST	Usuario de Prueba	PENDING	0	FRIO	2026-08-13 21:23:19.051	2026-09-01 22:11:27.152	\N	\N	\N	{"simulator_session": 1788300687151}	simulator	\N
\.
...
cmszfd448000314dpq1f22qgd	cmsqx4ls80003j7k6lj5an1j4	assistant	¡Hola Daniel! ¿En qué te puedo ayudar hoy?	2026-08-19 01:40:37.784	5599	30	SERVICE	Agente Principal	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIxRjU0RUI2MTE2OEZEMjcwNjMA	\N	\N	\N	\N	\N
...
cmszfdnql000514dph9q5ilvd	cmsqx4ls80003j7k6lj5an1j4	user	Quiero saber mas info de melto	2026-08-19 01:41:03.213	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
...
cmszfdtqz000714dpc4ld1pki	cmsqx4ls80003j7k6lj5an1j4	assistant	¡Claro! Te cuento un poco sobre nuestro producto: son sorbetes premium artesanales con proteína, disponibles en sabores de *Vainilla*, *Chocolate*, *Cookies & Cream* y *Café*.\n\n¿Qué te gustaría saber en específico? ¿Precios, sabores, o cómo hacer tu pedido (delivery o pickup)?	2026-08-19 01:41:11.003	5566	176	SERVICE	Agente Principal	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJERjM4NjEyQzVCNUYxQ0M4RkIA	\N	\N	\N	\N	\N
...
cmszfe91j000914dptzxkq9oj	cmsqx4ls80003j7k6lj5an1j4	user	Sabores	2026-08-19 01:41:30.824	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
...
cmswkpaq9000d3nca9j4vs15j	cmsr0zhi2004jaudy8zs9vu4e	user	Si, confirmo	2026-08-17 01:46:45.778	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	button_reply	\N	\N	\N
cmsxnknfn00035m8rks5pcx1i	cmsr0zhi2004jaudy8zs9vu4e	agent	Muchas gracias por su confirmacion :)	2026-08-17 19:54:53.986	\N	\N	SERVICE	\N	\N	\N	\N	DELIVERED	wamid.HBgLMTMwNTc0ODE4NzAVAgARGBI2RTdCODRDNDVFNERCREZFQUYA	\N	\N	\N	\N	\N
cmsxnlk1l000f3ncazocy1hz4	cmsr0zhi2004jaudy8zs9vu4e	user	Habia confirmado en otro chat	2026-08-17 19:55:36.249	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmsxnlso9000h3ncamxlu1coa	cmsr0zhi2004jaudy8zs9vu4e	user	Pero queria recnfirmar	2026-08-17 19:55:47.433	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmsy2z1a2000j3nca9izepppj	cmsr10ex6005naudyvqyzej2u	user	Si, confirmo	2026-08-18 03:05:59.352	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	button_reply	\N	\N	\N
cmszfcy40000114dpho5t98a3	cmsqx4ls80003j7k6lj5an1j4	user	Hola	2026-08-19 01:40:30.001	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmszflzrn000j14dp46qjxrmj	cmsqx4ls80003j7k6lj5an1j4	assistant	[Sistema] Límite mensual de mensajes alcanzado. El bot ha sido desactivado.	2026-08-19 01:47:32.051	5702	37	SERVICE	Agente Principal	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIzMzA5N0QwQTUyQjA3RjM1ODYA	\N	\N	\N	\N	\N
cmszfedz1000b14dpcmdukoz1	cmsqx4ls80003j7k6lj5an1j4	assistant	Tenemos 4 sabores disponibles:\n\n- *Vainilla*\n- *Chocolate*\n- *Cookies & Cream*\n- *Café*\n\n¿Cuál te llama más la atención?	2026-08-19 01:41:37.214	5617	69	SERVICE	Agente Principal	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI3OTIwNUE5MTA5RkMxOUZCMkYA	\N	\N	\N	\N	\N
cmszfex57000d14dpzjhxutod	cmsqx4ls80003j7k6lj5an1j4	user	Vainilla	2026-08-19 01:42:02.06	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmszfeza3000f14dpj7ag8zzg	cmsqx4ls80003j7k6lj5an1j4	assistant	[Sistema] Límite mensual de mensajes alcanzado. El bot ha sido desactivado.	2026-08-19 01:42:04.827	0	0	SERVICE	\N	\N	\N	\N	failed	\N	\N	\N	\N	\N	\N
cmszflv37000h14dpsgoxquxx	cmsqx4ls80003j7k6lj5an1j4	user	Hola?	2026-08-19 01:47:25.987	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmszfumv5000l14dpx8xn850y	cmsqx4ls80003j7k6lj5an1j4	user	Que es eso?	2026-08-19 01:54:15.233	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmszgcahq0003in027woee5ie	cmsqx4ls80003j7k6lj5an1j4	agent	de que sabor lo deseas?	2026-08-19 02:07:59.007	\N	\N	SERVICE	\N	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIzQTU0M0JFMzA4NEY5OUU2NTEA	\N	\N	\N	\N	\N
cmszfurfs000n14dpytt3s3hf	cmsqx4ls80003j7k6lj5an1j4	assistant	[Sistema] Límite mensual de mensajes alcanzado. El bot ha sido desactivado.	2026-08-19 01:54:21.16	5712	37	SERVICE	Agente Principal	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI1NkFFMTkyQUMzMEJFNzdEMzQA	\N	\N	\N	\N	\N
cmszg8zuo000p14dp380rjnnm	cmsqzz9750013j7k6iwtfw7z4	user	.	2026-08-19 02:05:25.248	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmszgbzgs0001in02m4iwwtn0	cmsqx4ls80003j7k6lj5an1j4	agent	Hola, en que te puedo ayudar?	2026-08-19 02:07:44.717	\N	\N	SERVICE	\N	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIyMzA1Q0NFQzk2QkJCQUYyQjUA	\N	\N	\N	\N	\N
cmszgc3i90001zal2w6ehp7qv	cmsqx4ls80003j7k6lj5an1j4	user	Quiero un sorbete	2026-08-19 02:07:49.954	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmszgdpmp0007zal2jd2c4ua2	cmsqx4ls80003j7k6lj5an1j4	user	Cafe	2026-08-19 02:09:05.282	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmszgct5b0003zal26cblx0om	cmsqx4ls80003j7k6lj5an1j4	user	Que sabores tienen?	2026-08-19 02:08:23.184	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmszgcyae0005zal2f0r490jv	cmsqx4ls80003j7k6lj5an1j4	assistant	Tenemos 4 sabores disponibles:\n\n- *Vainilla*\n- *Chocolate*\n- *Cookies & Cream*\n- *Café*\n\n¿Cuál prefieres?	2026-08-19 02:08:29.847	5624	66	SERVICE	Agente Principal	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIyQkNCREU1OUQzREFBNUFERDQA	\N	\N	\N	\N	\N
cmszgdsbp0009zal2s3ses9ny	cmsqx4ls80003j7k6lj5an1j4	assistant	[Sistema] Límite mensual de mensajes alcanzado. El bot ha sido desactivado.	2026-08-19 02:09:08.774	0	0	SERVICE	\N	\N	\N	\N	failed	\N	\N	\N	\N	\N	\N
cmszgeypr000bzal21bpk4pgy	cmsqx4ls80003j7k6lj5an1j4	user	Hola?	2026-08-19 02:10:03.711	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmszglgas000jzal2osfk6uqb	cmsqx4ls80003j7k6lj5an1j4	user	Vainilla	2026-08-19 02:15:06.436	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmszgm53a000nzal2udkzppbm	cmsqx4ls80003j7k6lj5an1j4	user	Y que dias se puede pickup?	2026-08-19 02:15:38.566	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmszgn1d4000rzal24dzl4i2s	cmsqx4ls80003j7k6lj5an1j4	user	Si me parece para el sabado	2026-08-19 02:16:20.393	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmszgf4xc000dzal2vkcsd1iq	cmsqx4ls80003j7k6lj5an1j4	assistant	Hola, DA. Perfecto, sorbete de *Café* anotado.\n\n¿Lo quieres para *pickup* en Nuevo Cuscatlán o prefieres *delivery* (con costo extra de $2)?	2026-08-19 02:10:11.76	5517	135	SERVICE	Agente Principal	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJEOUVBODMxQTUyNzk0NDBFNzUA	\N	\N	\N	\N	\N
cmszgky7e000fzal20l2cfcc9	cmsqx4ls80003j7k6lj5an1j4	user	Mejor otro sabor	2026-08-19 02:14:42.986	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmszgl3af000hzal2wqco4j0q	cmsqx4ls80003j7k6lj5an1j4	assistant	Claro, ¿cuál de estos prefieres entonces?\n\n- *Vainilla*\n- *Chocolate*\n- *Cookies & Cream*\n- *Café*	2026-08-19 02:14:49.576	5509	59	SERVICE	Agente Principal	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI5MzQ3RUI1NEYzQjg3MUZDOEQA	\N	\N	\N	\N	\N
cmszgll8e000lzal2t6v5u46z	cmsqx4ls80003j7k6lj5an1j4	assistant	¡Listo! Sorbete de *Vainilla* anotado.\n\n¿Lo quieres para *pickup* en Nuevo Cuscatlán o prefieres *delivery* (con costo extra de $2)?	2026-08-19 02:15:12.83	5570	74	SERVICE	Agente Principal	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI1QjhGQjAzNkE5NjgzRDQzRTEA	\N	\N	\N	\N	\N
cmszgmaa0000pzal2cqozdbdd	cmsqx4ls80003j7k6lj5an1j4	assistant	El pickup está disponible los *Sábados* de *10:00 am a 12:00 pm* en Nuevo Cuscatlán.\n\n¿Te gustaría agendar tu pickup para este sábado?	2026-08-19 02:15:45.289	5671	70	SERVICE	Agente Principal	\N	\N	\N	SENT	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJBMjVGRDZENjcxOTlCM0FFRDgA	\N	\N	\N	\N	\N
cmszgn4ci000tzal2zw47cjt4	cmsqx4ls80003j7k6lj5an1j4	assistant	[Sistema] Límite mensual de mensajes alcanzado. El bot ha sido desactivado.	2026-08-19 02:16:24.258	0	0	SERVICE	\N	\N	\N	\N	failed	\N	\N	\N	\N	\N	\N
cmt0wo01m0005fvxoo9prehkc	cmt0wnzuo0003fvxolbh3vdrd	user	hola	2026-08-20 02:32:45.371	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt28j2d30001skkfoanwii3h	cmsqx4ls80003j7k6lj5an1j4	user	Hola	2026-08-21 00:52:36.663	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt0wo6sj0007fvxoy3bk1hsp	cmt0wnzuo0003fvxolbh3vdrd	assistant	¡Hola Paulina! 👋 ¿Desea reservar una cancha? Cuénteme para qué fecha y hora le gustaría.	2026-08-20 02:32:54.115	8061	51	SERVICE	Agente Principal	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzc0MjAwNjMVAgARGBI0MDg1MTkyOTg2NEMwMzBERjIA	\N	\N	\N	\N	\N
cmt0wots10009fvxoza8h7r7v	cmt0wnzuo0003fvxolbh3vdrd	user	Mañana a las 9pm	2026-08-20 02:33:23.905	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt2ya41z0000nhqpdbndmht5	cmsqx4ls80003j7k6lj5an1j4	system	El bot se ha reactivado automáticamente tras 12 horas de inactividad.	2026-08-21 12:53:28.965	\N	\N	\N	\N	\N	\N	\N	DELIVERED	\N	\N	\N	\N	\N	\N
cmt0wp7h7000bfvxonrl9ty6d	cmt0wnzuo0003fvxolbh3vdrd	assistant	Disculpe Paulina, estoy teniendo un problema técnico para verificar la disponibilidad en este momento. 😕 Le voy a transferir con un asesor para que le ayude directamente con su reserva.	2026-08-20 02:33:41.659	24879	448	SERVICE	Agente Principal	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzc0MjAwNjMVAgARGBJDNjY4OTVERTFDN0UzNzRGQTcA	\N	\N	\N	\N	\N
cmt1mfo3s000cfvxoq8fq16k5	cmt0wnzuo0003fvxolbh3vdrd	system	El bot se ha reactivado automáticamente tras 12 horas de inactividad.	2026-08-20 14:34:06.662	\N	\N	\N	\N	\N	\N	\N	DELIVERED	\N	\N	\N	\N	\N	\N
cmt25ofy50001nf3yn0zl0t2t	cmsqx4ls80003j7k6lj5an1j4	user	Hola	2026-08-20 23:32:48.701	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt34n8pt0006nhqpw4pm5lmp	cmt34n8i70004nhqpakyo2hqj	user	Hola	2026-08-21 15:51:39.233	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt25omzu0003nf3yu0mouqyq	cmsqx4ls80003j7k6lj5an1j4	assistant	¡Hola de nuevo! Perfecto, entonces reservamos tu pickup para el *sábado 22 de agosto*.\n\nEl horario disponible es de *10:00 am a 12:00 pm*. ¿A qué hora te gustaría pasar a recogerlo?	2026-08-20 23:32:57.834	5696	244	SERVICE	Agente Principal	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI5RUMwRjZCRDREOTgxMTQ3ODYA	\N	\N	\N	\N	\N
cmt25pvmm0005nf3ybyxba0ks	cmsqx4ls80003j7k6lj5an1j4	user	quiero hablar con un humano	2026-08-20 23:33:55.679	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt25q11d0007nf3ypap7pvd6	cmsqx4ls80003j7k6lj5an1j4	assistant	Entendido, te transfiero con un asesor de inmediato.	2026-08-20 23:34:02.689	5725	37	SERVICE	Agente Principal	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIwM0NBQzY2Nzc4QUJCMTREMUUA	\N	\N	\N	\N	\N
cmt25reaz0009nf3y03sxcf42	cmsr0mebc004tc3we1wu3mqy7	user	No, no podre asistir	2026-08-20 23:35:06.539	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	button_reply	\N	\N	\N
cmt26ipsc00012klsqmdj4y8j	cmsqx4ls80003j7k6lj5an1j4	user	hola	2026-08-20 23:56:21.132	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt3iiwot000lqj3srlwwu04r	cmsr2ejjx0006fsu7i0dcrpzu	user	pickup	2026-08-21 22:20:11.645	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt26o30x00012qh98nh86698	cmsqx4ls80003j7k6lj5an1j4	agent	Hola	2026-08-21 00:00:31.57	\N	\N	SERVICE	\N	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI5RDY3MzlGNUFBNTVGM0I4MDIA	\N	\N	\N	\N	\N
cmt34ntjl0001mrml1kar7oqd	cmt34n8i70004nhqpakyo2hqj	agent	Shh	2026-08-21 15:52:06.225	\N	\N	SERVICE	\N	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzU1ODI4NjAVAgARGBJGQkU2ODc5RDIwMkUyQzlDQzgA	\N	\N	\N	\N	\N
cmt26p4on00032qh98nz6j0jx	cmsqx4ls80003j7k6lj5an1j4	agent	Prueba	2026-08-21 00:01:20.375	\N	\N	SERVICE	\N	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJGREFFMEI0MjFBMDAxQjdFMzIA	\N	\N	\N	\N	\N
cmt34tmdm0008nhqpnajneatf	cmt34n8i70004nhqpakyo2hqj	user	Jiji	2026-08-21 15:56:36.875	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt26pxx600052qh98cl93igq	cmsqx4ls80003j7k6lj5an1j4	agent	.	2026-08-21 00:01:58.266	\N	\N	SERVICE	\N	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJEQkE5RTc2NDc1RkEzQ0U3NzUA	\N	\N	\N	\N	\N
cmt26qdfe00032klso4c5qiu0	cmsqx4ls80003j7k6lj5an1j4	user	.	2026-08-21 00:02:18.363	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt26voch00052klsdk3ql2ge	cmsqx4ls80003j7k6lj5an1j4	user	Prueba	2026-08-21 00:06:25.794	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt26ween00072klscxhw4h5s	cmsqx4ls80003j7k6lj5an1j4	user	Y le pone la burbujita y todo	2026-08-21 00:06:59.567	\N	\N	\N	\N	\N	\N	https://lndqwnxodozquindlqzo.supabase.co/storage/v1/object/public/media/uploads/a40ebe82-5e24-4dcc-945a-fc25ca397afc-adjunto.jpeg	SENT	\N	adjunto.jpeg	image	https://lndqwnxodozquindlqzo.supabase.co/storage/v1/object/public/media/uploads/a40ebe82-5e24-4dcc-945a-fc25ca397afc-adjunto.jpeg	\N	\N
cmt34tnjs000anhqpu5shk8yh	cmt34n8i70004nhqpakyo2hqj	user	Ta vergon	2026-08-21 15:56:38.392	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt35crfo000cnhqpxujsfmgd	cmt34n8i70004nhqpakyo2hqj	user	Hoal hola	2026-08-21 16:11:29.893	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt3igrrs000dqj3se4d472zp	cmsr2ejjx0006fsu7i0dcrpzu	user	hola	2026-08-21 22:18:31.96	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt3igx3e000fqj3sjj3hywst	cmsr2ejjx0006fsu7i0dcrpzu	assistant	¡Hola! Bienvenido a nuestra tienda de sorbetes premium artesanales con proteína. Tenemos sabores de vainilla, chocolate, cookies & cream y café.\n\n¿En qué te puedo ayudar hoy?	2026-08-21 22:18:38.858	5158	157	\N	Agente Principal	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt3ihnit000hqj3sh6vinm1r	cmsr2ejjx0006fsu7i0dcrpzu	user	quiro uno de galleta y uno de cafe	2026-08-21 22:19:13.109	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt3ihs7f000jqj3sxfyphfno	cmsr2ejjx0006fsu7i0dcrpzu	assistant	¡Perfecto! Uno de *Cookies & Cream* y uno de *Café*, cada uno a $5, o sea $10 en total.\n\n¿Los quieres para *delivery* (con $2 extra de envío) o prefieres pasar a recogerlos a nuestro punto en Nuevo Cuscatlán (disponible los sábados de 10:00 am a 12:00 pm)?	2026-08-21 22:19:19.127	5261	193	\N	Agente Principal	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt3ij08h000nqj3szhqk6uk2	cmsr2ejjx0006fsu7i0dcrpzu	assistant	¡Genial! Entonces sería pickup en Nuevo Cuscatlán, disponible el sábado de 10:00 am a 12:00 pm.\n\nTu pedido: 1 Cookies & Cream + 1 Café = $10 (sin costo extra de envío).\n\n¿Me confirmas tu nombre para dejar el pedido listo?	2026-08-21 22:20:16.241	5400	119	\N	Agente Principal	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt3ijpl1000pqj3ss813tofu	cmsr2ejjx0006fsu7i0dcrpzu	user	mira mejor delivery no puedo ir	2026-08-21 22:20:49.093	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt3iju5e000rqj3sa1tgr27f	cmsr2ejjx0006fsu7i0dcrpzu	assistant	¡Sin problema! Cambiamos a *delivery*, entonces sería $10 + $2 de envío = *$12 total*.\n\nPara coordinar la entrega, ¿me compartes tu nombre y dirección, por favor?	2026-08-21 22:20:55.01	5535	180	\N	Agente Principal	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt3ikryi000tqj3s6za8bo9n	cmsr2ejjx0006fsu7i0dcrpzu	user	quiero hablar con un asesor	2026-08-21 22:21:38.826	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt3ikv63000vqj3s52d0i7es	cmsr2ejjx0006fsu7i0dcrpzu	assistant	Entendido, te transfiero de inmediato con un asesor para que te ayude con tu pedido.	2026-08-21 22:21:42.987	5627	49	\N	Agente Principal	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt3il3ch000012qk0dml1v2m	cmsr2ejjx0006fsu7i0dcrpzu	system	El bot se ha reactivado automáticamente tras 12 horas de inactividad.	2026-08-21 22:21:53.257	\N	\N	\N	\N	\N	\N	\N	DELIVERED	\N	\N	\N	\N	\N	\N
cmt3pc7hd000125r0t9v36njp	cmsqx4ls80003j7k6lj5an1j4	user	.	2026-08-22 01:30:56.353	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmtc4h76b0001o83y2b0j48yj	cmsr0llot003tc3welv6bkg80	user	No, no podre asistir	2026-08-27 22:56:52.878	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	button_reply	\N	\N	\N
cmtc4iysg0003o83ybtuxveno	cmsr0llot003tc3welv6bkg80	user	Me disculpo pues me acaban  de programar una cirugia para el viernes 4 de septiembre	2026-08-27 22:58:15.328	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmtc6k5790004ozjwpnpn813b	cmtc6k4sc0002ozjwmia4imcp	user	Adonde puedo apagar el AI para un cliente?	2026-08-27 23:55:09.525	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmtiz2s1x0017ugbv6yoaqw9e	cmstfhrba0003r8yu0407koh5	user	Quisiera 7pm	2026-09-01 18:00:05.253	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt3pclko0001sx8t10tpd35b	cmsqx4ls80003j7k6lj5an1j4	agent	voice-note-1787362270755.webm	2026-08-22 01:31:14.616	\N	\N	SERVICE	\N	\N	\N	\N	FAILED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIzRENGMUVFNEQ4NkIxRDE4OUQA	voice-note-1787362270755.webm	audio	https://lndqwnxodozquindlqzo.supabase.co/storage/v1/object/public/media/uploads/029f9b5d-b378-4717-8578-355b56478e6b-voice-note-1787362270755.webm	\N	\N
cmt3pm84k00019e9y5mrfjj6b	cmsqx4ls80003j7k6lj5an1j4	agent	voice-note-1787362720112.mp4	2026-08-22 01:38:43.749	\N	\N	SERVICE	\N	\N	\N	\N	FAILED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI5MEZBNDNDNkNEQzhDNDU5MzkA	voice-note-1787362720112.mp4	audio	https://lndqwnxodozquindlqzo.supabase.co/storage/v1/object/public/media/uploads/02c34fdb-3920-4c4b-8e49-f2c490eea3c8-voice-note-1787362720112.mp4	\N	\N
cmt3pw9570001dyh0ejzk24o1	cmsqx4ls80003j7k6lj5an1j4	agent	voice-note-1787363187140.mp4	2026-08-22 01:46:31.627	\N	\N	SERVICE	\N	\N	\N	\N	FAILED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJEMDc1MDQxRUEwM0M0QkFGNDkA	voice-note-1787363187140.mp4	audio	https://lndqwnxodozquindlqzo.supabase.co/storage/v1/object/public/media/uploads/610b0278-c2a7-4658-87be-93b834a59554-voice-note-1787363187140.mp4	\N	\N
cmt3q6jts0001f1sm5s2uialo	cmsqx4ls80003j7k6lj5an1j4	agent	voice-note-1787363668079.mp4	2026-08-22 01:54:32.033	\N	\N	SERVICE	\N	\N	\N	\N	FAILED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI1QzlGRkM4NDZFMUREQzE2RjgA	voice-note-1787363668079.mp4	audio	https://lndqwnxodozquindlqzo.supabase.co/storage/v1/object/public/media/uploads/156a58f6-c82a-46e2-b4b2-d98f5b41ef01-voice-note-1787363668079.mp4	Meta Error: Media upload error	\N
cmt3qc4kw00014dfusyv4je4q	cmsqx4ls80003j7k6lj5an1j4	agent	voice-note-1787363926990.mp4	2026-08-22 01:58:52.208	\N	\N	SERVICE	\N	\N	\N	\N	FAILED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJBMDdEMTY3NzA2ODNBMUZGMjQA	voice-note-1787363926990.mp4	audio	https://lndqwnxodozquindlqzo.supabase.co/storage/v1/object/public/media/uploads/263c32e9-891a-4ada-b766-ed434aae1456-voice-note-1787363926990.mp4	Meta Error: Media upload error	\N
cmt5zbijk0002h94elzo73fv4	cmsqx4ls80003j7k6lj5an1j4	system	El bot se ha reactivado automáticamente tras 12 horas de inactividad.	2026-08-23 15:45:52.54	\N	\N	\N	\N	\N	\N	\N	DELIVERED	\N	\N	\N	\N	\N	\N
cmt3r2np80001n449m5hdud73	cmsqx4ls80003j7k6lj5an1j4	agent	voice-note-1787365163579.mp4	2026-08-22 02:19:30.045	\N	\N	SERVICE	\N	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJCQzAzQ0E5RjAyODI0QkFBQzEA	voice-note-1787365163579.mp4	audio	https://lndqwnxodozquindlqzo.supabase.co/storage/v1/object/public/media/uploads/19539f96-152a-4ea7-a09e-bed2ce4cac81-voice-note-1787365163579.ogg	\N	\N
cmt4t4u0j0001iaffxzp6pjdx	cmsqx4ls80003j7k6lj5an1j4	agent	voice-note-1787429089239.mp4	2026-08-22 20:04:56.947	\N	\N	SERVICE	\N	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJFQjExQTk2RTAwNDhCRjFGNTcA	voice-note-1787429089239.mp4	audio	https://lndqwnxodozquindlqzo.supabase.co/storage/v1/object/public/media/uploads/51af3ab3-b53c-4770-afb8-056d6bae5b1e-voice-note-1787429089239.ogg	\N	\N
cmt3rofhy0001iwuef8bbrn4j	cmsqx4ls80003j7k6lj5an1j4	agent	voice-note-1787366181845.mp4	2026-08-22 02:36:25.846	\N	\N	SERVICE	\N	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJFRTEyQkMxRURDRjJGQzdGOTIA	voice-note-1787366181845.mp4	audio	https://lndqwnxodozquindlqzo.supabase.co/storage/v1/object/public/media/uploads/d78343f1-5d64-4129-a0fb-cfaf4d14f090-voice-note-1787366181845.ogg	\N	\N
cmt4hf9w20000cm1rpzuefeet	cmsqx4ls80003j7k6lj5an1j4	system	El bot se ha reactivado automáticamente tras 12 horas de inactividad.	2026-08-22 14:37:08.69	\N	\N	\N	\N	\N	\N	\N	DELIVERED	\N	\N	\N	\N	\N	\N
cmt4t9c9m000111dbahx9g0cp	cmsqx4ls80003j7k6lj5an1j4	user	[Audio Transcrito]: "Prueba, prueba, prueba"	2026-08-22 20:08:27.226	\N	\N	\N	\N	\N	\N	\N	SENT	\N	adjunto.ogg	audio	https://lndqwnxodozquindlqzo.supabase.co/storage/v1/object/public/media/uploads/be0ed0e9-7059-4f84-964a-dc17ba0f4ff0-adjunto.ogg	\N	\N
cmt4stbio0001y9x9pkl4p0ne	cmsqx4ls80003j7k6lj5an1j4	agent	voice-note-1787428552859.mp4	2026-08-22 19:55:59.76	\N	\N	SERVICE	\N	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI1RTBGOUY5MzJBRDQ0NzkzMzAA	voice-note-1787428552859.mp4	audio	https://lndqwnxodozquindlqzo.supabase.co/storage/v1/object/public/media/uploads/3a14f3d5-8451-4cd0-aa0e-9fb9c1859a80-voice-note-1787428552859.ogg	\N	\N
cmt4tncne000111fyfngoxbdk	cmt34n8i70004nhqpakyo2hqj	user	Prueba	2026-08-22 20:19:20.906	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt4tneei000311fyyrg90zew	cmt34n8i70004nhqpakyo2hqj	user	Wings wings	2026-08-22 20:19:23.179	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt4touwx0001trg29zyhmlkx	cmt34n8i70004nhqpakyo2hqj	agent	Mensaje de voz (0:00)	2026-08-22 20:20:31.234	\N	\N	SERVICE	\N	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzU1ODI4NjAVAgARGBJBQzFDNDA4RTU4RkEzMzY4MDQA	voice-note-1787430023173.mp4	audio	https://lndqwnxodozquindlqzo.supabase.co/storage/v1/object/public/media/uploads/070a6825-d4aa-4d7d-b541-17bd4b8efca3-voice-note-1787430023173.ogg	\N	\N
cmt4ttbug000511fyoxi7wlpd	cmt34n8i70004nhqpakyo2hqj	user	🎪 [Sticker]	2026-08-22 20:23:59.8	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt4ttcmv000711fyb5xd0x3a	cmt34n8i70004nhqpakyo2hqj	user	Esooooo	2026-08-22 20:24:00.824	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmt59knac0001vxe81m1h5emv	cmsqx4ls80003j7k6lj5an1j4	user		2026-08-23 03:45:08.581	\N	\N	\N	\N	\N	\N	https://lndqwnxodozquindlqzo.supabase.co/storage/v1/object/public/media/uploads/c4528505-d763-4def-8b47-1c1f46e4325b-adjunto.webp	SENT	\N	adjunto.webp	image	https://lndqwnxodozquindlqzo.supabase.co/storage/v1/object/public/media/uploads/c4528505-d763-4def-8b47-1c1f46e4325b-adjunto.webp	\N	\N
cmt59yyyy0001h94ee3bpx96z	cmt34n8i70004nhqpakyo2hqj	user		2026-08-23 03:56:16.906	\N	\N	\N	\N	\N	\N	https://lndqwnxodozquindlqzo.supabase.co/storage/v1/object/public/media/uploads/d20c2a16-6ec4-4987-88a8-389beea88cb2-adjunto.webp	SENT	\N	adjunto.webp	image	https://lndqwnxodozquindlqzo.supabase.co/storage/v1/object/public/media/uploads/d20c2a16-6ec4-4987-88a8-389beea88cb2-adjunto.webp	\N	\N
cmt7cn3u30000jsmvte2ild5f	cmsqx4ls80003j7k6lj5an1j4	system	El bot se ha reactivado automáticamente tras 12 horas de inactividad.	2026-08-24 14:46:34.538	\N	\N	\N	\N	\N	\N	\N	DELIVERED	\N	\N	\N	\N	\N	\N
cmt6mjydz0001e8c7fze79v0s	cmsqx4ls80003j7k6lj5an1j4	agent	Mensaje de voz (0:00)	2026-08-24 02:36:17.491	\N	\N	SERVICE	\N	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJBM0QzODJDRjFCRURDRkE3NEIA	voice-note-1787538970106.mp4	audio	https://lndqwnxodozquindlqzo.supabase.co/storage/v1/object/public/media/uploads/02a6ac49-3aa1-4fb2-b59c-f974dc0fdb8f-voice-note-1787538970106.ogg	\N	\N
cmt6mwncr000146xj5dzf4py8	cmsqx4ls80003j7k6lj5an1j4	agent	Mensaje de voz (0:02)	2026-08-24 02:46:09.724	\N	\N	SERVICE	\N	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI0ODc5MDZCN0U2QzU4RUU2MEMA	voice-note-1787539561561.mp4	audio	https://lndqwnxodozquindlqzo.supabase.co/storage/v1/object/public/media/uploads/bb649520-2485-407e-87d7-f37a7333b7c0-voice-note-1787539561561.ogg	\N	\N
cmt8ctv8m0001jsmvsjztmzwn	cmsqx4ls80003j7k6lj5an1j4	system	El bot se ha reactivado automáticamente tras 12 horas de inactividad.	2026-08-25 07:39:35.83	\N	\N	\N	\N	\N	\N	\N	DELIVERED	\N	\N	\N	\N	\N	\N
cmtbw2pnc0003jsmvwqb8cu3o	cmsqzz9750013j7k6iwtfw7z4	user	Hola	2026-08-27 19:01:40.055	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmtc3n0bc0004joo3sknol5xi	cmtc3mxrw0002joo3ct17d1us	user	adonde puedo cambiar mi contraseña	2026-08-27 22:33:24.311	\N	\N	\N	\N	\N	\N	\N	DELIVERED	\N	\N	\N	\N	\N	\N
cmtc3ndm40008joo35mv7syiv	cmtc3mxrw0002joo3ct17d1us	assistant	No tengo esa información exacta a la mano sobre dónde cambiar tu contraseña en la plataforma. 😊\n\n¿Te gustaría que te transfiera con un asesor para que te ayude con esto?	2026-08-27 22:33:41.138	2570	290	\N	Abita Bot	\N	\N	\N	DELIVERED	\N	\N	\N	\N	\N	\N
cmtc3to6e000ajoo38jg3nxj4	cmtc3mxrw0002joo3ct17d1us	user	si	2026-08-27 22:38:35.174	\N	\N	\N	\N	\N	\N	\N	DELIVERED	\N	\N	\N	\N	\N	\N
cmtc3u054000ejoo3w57kieo5	cmtc3mxrw0002joo3ct17d1us	assistant	Perfecto, te transfiero con un asesor para que te ayude. 👍	2026-08-27 22:38:50.68	2645	81	\N	Abita Bot	\N	\N	\N	DELIVERED	\N	\N	\N	\N	\N	\N
cmtc6k9b70006ozjwjii6l4g7	cmtc6k4sc0002ozjwmia4imcp	assistant	¡Hola! 👋 Muy sencillo:\n\nVe al módulo de *Bandeja (Inbox)*, abre el chat del cliente específico, y en la parte de arriba a la derecha del chat vas a ver un switch que dice *"IA"*. Simplemente lo apagas y listo, la IA dejará de responder en esa conversación para que puedas tomar el control manualmente (puedes escribir mensajes o mandar imágenes tú mismo).\n\nSi luego quieres que se reactive sola después de un tiempo, puedes configurar el *Auto-Wake* en Configuración -> Asistente de IA -> Reactivación Automática. 😊\n\n¿Te gustaría saber algo más sobre esto?	2026-08-27 23:55:14.852	5954	245	\N	Abita Bot	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmtc6l88n0008ozjwam6hv2k1	cmtc6k4sc0002ozjwmia4imcp	user	y si no quiero que se auto reactive?	2026-08-27 23:56:00.12	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmtc6lcp1000aozjwnohgp2el	cmtc6k4sc0002ozjwmia4imcp	assistant	¡Perfecto, no hay problema! 😊 Esa función es opcional, así que si prefieres tener el control total y que la IA no se reactive sola, simplemente debes ir a:\n\n*Configuración* -> pestaña *Asistente de IA* -> busca la opción *Reactivación Automática (Auto-Wake)* y apaga ese switch.\n\nAl dejarlo apagado, una vez que tú tomes el control de un chat (apagando la IA), esta permanecerá apagada hasta que tú mismo decidas volver a activarla manualmente desde la Bandeja. 👍\n\n¿Necesitas ayuda con algo más?	2026-08-27 23:56:05.893	6215	284	\N	Abita Bot	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmtc6m83r000cozjwyp8zqhvc	cmtc6k4sc0002ozjwmia4imcp	user	y puedo apagar el auto wake solo para un cliente especifico?	2026-08-27 23:56:46.6	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmtc6md5g000gozjwgkg10ihh	cmtc6k4sc0002ozjwmia4imcp	assistant	Es una excelente pregunta 🤔. Sin embargo, no tengo información exacta que confirme si esa configuración de *Auto-Wake* se puede personalizar por cliente específico o si es una regla general para toda tu cuenta.\n\nPara no darte información incorrecta, ¿te gustaría que te transfiera con uno de nuestros asesores para que te confirme este detalle con precisión?	2026-08-27 23:56:53.141	6457	305	\N	Abita Bot	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmtcbgynh0001ugbvwkxp7rlr	cmsr0ldea003hc3wepvvjgoj7	user	No, no podre asistir	2026-08-28 02:12:39.149	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	button_reply	\N	\N	\N
cmtgdq5up0003ugbv6vf7ja3x	cmsr0mw5m005hc3wep30hn0jl	user	Hola como estas, finalmente no voy a poder asistir por temas laborales. Mil gracias.	2026-08-30 22:26:52.32	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmthr6bjq0005ugbvdqp8cmnu	cmt34n8i70004nhqpakyo2hqj	user	Hola	2026-08-31 21:31:07.381	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmthujidt0007ugbvgdw6hmy2	cmstfhrba0003r8yu0407koh5	user	Hola	2026-08-31 23:05:21.616	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmthumbt6000lugbvq3oyeufq	cmstfhrba0003r8yu0407koh5	assistant	Entiendo, Sebastian. Para poder revisarle el calendario necesito que me indique un día específico y el horario aproximado que le interesa (ej: hoy a las 6:00 pm, o miércoles a las 5:00 pm). ¿Cuál prefiere? 😊	2026-08-31 23:07:33.067	8812	206	SERVICE	Agente Principal	\N	\N	\N	SENT	wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI1QkZBQUM0NkYyQzMzMUMwNEEA	\N	\N	\N	\N	\N
cmthujo770009ugbvapgsdem8	cmstfhrba0003r8yu0407koh5	assistant	¡Hola de nuevo, Sebastian! ¿Seguimos con la reserva de 7:15 pm a 8:15 pm? Solo necesito que me confirme la fecha 📅	2026-08-31 23:05:29.155	8662	67	SERVICE	Agente Principal	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI5MjlGREE0MTdCOTZCQUQ4NDAA	\N	\N	\N	\N	\N
cmthukfe3000bugbv9wi679hh	cmstfhrba0003r8yu0407koh5	user	Que espacios tiene esta semana	2026-08-31 23:06:04.396	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmthumqnm000nugbv7cqjwt9d	cmstfhrba0003r8yu0407koh5	user	Quiero saber que horarios hay cada dia\nLunes	2026-08-31 23:07:52.306	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmthukm4n000dugbv142n2j2n	cmstfhrba0003r8yu0407koh5	assistant	Con gusto, Sebastian. Solo le comento que las reservas deben ser en horas exactas (ej: 7:00 pm u 8:00 pm), no a las 7:15. \n\n¿Para qué día de esta semana le gustaría consultar disponibilidad?	2026-08-31 23:06:13.127	8690	277	SERVICE	Agente Principal	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNjA1NDU1OTIVAgARGBIwQTNCMTlEQUIxRDkwMjhFNEMA	\N	\N	\N	\N	\N
cmthulhwe000fugbvl1rzze6g	cmstfhrba0003r8yu0407koh5	user	Quiero saber que horarios hay libres esta semana. No tiene que ser las 7:15pm	2026-08-31 23:06:54.302	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmthulpee000hugbvj0k3799z	cmstfhrba0003r8yu0407koh5	assistant	Perfecto. Para poder revisarle la disponibilidad, ¿me podría indicar qué día de esta semana le interesa (martes, miércoles, jueves...) y aproximadamente en qué horario? Así reviso el calendario y le confirmo los espacios libres.	2026-08-31 23:07:04.023	8775	211	SERVICE	Agente Principal	\N	\N	\N	SENT	wamid.HBgLNTAzNjA1NDU1OTIVAgARGBJBMThBNEVENzgyMkVBQTU5RUEA	\N	\N	\N	\N	\N
cmthum5sj000jugbvcznuw6c0	cmstfhrba0003r8yu0407koh5	user	Cualquier dia	2026-08-31 23:07:25.267	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmtiyxr4t000xugbvays6hbdw	cmstfhrba0003r8yu0407koh5	assistant	¡Hola Sebastian! Claro que sí 😊 ¿Para qué fecha y a qué hora le gustaría reservar?	2026-09-01 17:56:10.781	8954	100	SERVICE	Agente Principal	\N	\N	\N	SENT	wamid.HBgLNTAzNjA1NDU1OTIVAgARGBJFMDk1Nzc1RTBGMTM2QjMxREQA	\N	\N	\N	\N	\N
cmthun3tk000pugbv8om6hp3n	cmstfhrba0003r8yu0407koh5	assistant	Disculpe Sebastian, estoy teniendo un problema de conexión para revisar el calendario en este momento. Para no hacerle perder tiempo, ¿le parece si lo transfiero con un asesor que pueda ayudarle directamente con la disponibilidad?	2026-08-31 23:08:09.369	27245	581	SERVICE	Agente Principal	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNjA1NDU1OTIVAgARGBJBMEFFNkVGMUQ2QUYyMDBEOUYA	\N	\N	\N	\N	\N
cmthup23c000rugbvvh3mgga5	cmstfhrba0003r8yu0407koh5	user	Trata otra vez	2026-08-31 23:09:40.441	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmthup9v0000tugbv6yf1lv2o	cmstfhrba0003r8yu0407koh5	assistant	Claro, Sebastian. Para el lunes, ¿qué horario le interesa consultar? (ej: 3:00 pm, 5:00 pm, 7:00 pm, etc.) Así reviso el calendario y le confirmo si está disponible.	2026-08-31 23:09:50.508	8905	353	SERVICE	Agente Principal	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI3M0U0MTA3QzMyQ0FFMjFCQUIA	\N	\N	\N	\N	\N
cmtiyxly9000vugbvr1sw9udc	cmstfhrba0003r8yu0407koh5	user	Hola\nQueria reservar cancha	2026-09-01 17:56:04.064	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmtiyyiwg0011ugbva6tvpn8n	cmstfhrba0003r8yu0407koh5	assistant	Claro, Sebastian. El viernes atendemos de 3:00 pm a 10:00 pm. ¿Qué horario le interesa para que le confirme la disponibilidad? 😊	2026-09-01 17:56:46.768	8919	231	SERVICE	Agente Principal	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI1NzQ4Q0M4NjcwRDhERUU2NDcA	\N	\N	\N	\N	\N
cmtiyybt1000zugbvqd3balsf	cmstfhrba0003r8yu0407koh5	user	Que espacios tienes este viernes	2026-09-01 17:56:37.573	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmtiyzhwm0013ugbvl460qbi9	cmstfhrba0003r8yu0407koh5	user	Pero que espacios tiene disponible	2026-09-01 17:57:32.134	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmtiz3mo0001bugbvueoie802	cmstfhrba0003r8yu0407koh5	user	Seria sebastian recinos	2026-09-01 18:00:44.928	\N	\N	\N	\N	\N	\N	\N	SENT	\N	\N	\N	\N	\N	\N
cmtiyzst90015ugbv376u19ly	cmstfhrba0003r8yu0407koh5	assistant	¡Buenas noticias, Sebastian! El viernes 4 de septiembre tenemos todo el día libre, de 3:00 pm a 10:00 pm. \n\n¿Qué horario prefiere para su reserva? Le recuerdo que la tarifa es de $25/hora antes de las 6:00 pm y $35/hora después de las 6:00 pm.	2026-09-01 17:57:46.269	17993	568	SERVICE	Agente Principal	\N	\N	\N	SENT	wamid.HBgLNTAzNjA1NDU1OTIVAgARGBIyMEQ4Qzk0MkY2ODlBMzRDNDgA	\N	\N	\N	\N	\N
cmtiz31610019ugbvvq7zfkdr	cmstfhrba0003r8yu0407koh5	assistant	¡Perfecto! El viernes 5 de septiembre a las 7:00 pm está disponible. La tarifa después de las 6:00 pm es de $35 por hora.\n\n¿Le confirmo la reserva a nombre de Sebastian R?	2026-09-01 18:00:17.066	18053	158	SERVICE	Agente Principal	\N	\N	\N	SENT	wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI5RTUzNTVGOEY2NEYyRUYyNUUA	\N	\N	\N	\N	\N
cmtiz3ypd001fugbvfq8dwknp	cmstfhrba0003r8yu0407koh5	assistant	¡Listo, Sebastian! Su reserva quedó confirmada:\n\n📅 Viernes 5 de septiembre\n🕖 7:00 pm - 8:00 pm\n💰 $35 (tarifa después de las 6:00 pm)\n\nComo es primera vez, le comparto los datos para el anticipo del 50% ($17.50):\n\n*Banco Agrícola*\nBeneficiario: Gole SA de CV\nCuenta: 005030494738\nTipo: Cuenta Corriente\n\nEn la entrada, decirle al vigilante que vienen a nombre de *Sebastian Recinos*. Cuando realice el pago, favor enviarme el comprobante. ⚽️	2026-09-01 18:01:00.529	27225	488	SERVICE	Agente Principal	\N	\N	\N	DELIVERED	wamid.HBgLNTAzNjA1NDU1OTIVAgARGBIyNTI1OEVDNjA0MTExNjk2NDkA	\N	\N	\N	\N	\N
\.
...
cmsqyyesa0009m4q8abr3fk4g	cmsqww9qj0004m4q86g2jpp6a	google-calendar	34f708a6-7b8c-4b56-9f45-60fc1bc759a0	DISCONNECTED	\N	2026-08-13 03:39:08.507	2026-08-21 03:10:39.048
cmss0xs3x000cin22hbqgnqfl	cmsrzknn30003in22zrate8g2	google-calendar	e816c821-d5c0-4a20-aac6-339f8c1a2c77	CONNECTED	\N	2026-08-13 21:22:24.525	2026-08-31 23:09:21.533
\.
...
cmsrzknn30003in22zrate8g2	cmsrzknn10002in226nff6d48	Proyecto Principal	2026-08-13 20:44:12.531	1767001538079280	1307992975727019	d8633a0374e275edc0a1c498:660b6a31f6c0f6210d577d1009280ac0:	t	t	{}	{50360545592}	APPROVED	12
...
cmtc34o1p0001r0ihw4te4lbt	cmtc34o1m0000r0ihrddv3b5f	Internal Support Project	2026-08-27 22:19:08.601			\N	f	f	{}	{}	\N	168
\.
...
COPY "public"."PushSubscription" ("id", "clientId", "endpoint", "p256dh", "auth", "createdAt", "notifyAllMessages", "notifyHandoffs") FROM stdin;
cmt28ijcl0001g4ymczo4ejbf	cmsqww9qj0003m4q8135x6e7z	https://web.push.apple.com/QHNsVbRZesrgKqoQNhVk_yQfhE6F2Y36uCVzMdJFnFql27Eq0ViPCUdxU1vpIn4QTMwjmuXPXRaoGKg4jdY8jHgNf-Hln3vsC-MvnAQGCOp-bceDVkBeybgIwlgHJNNsN6UjiTkOh_jeCX2eE7O8UMiIsabwDHoRAX4TcZZMQc0	BEGlvJncKp27wKDgBdVeeibHv0d5Mf7A9rqXn4r38fpKbamfinlSupmSgGSXTgJUgHhDs_uCrJEIQe83A-aauEQ	hpq5MgWK6qaw6kiHUXp9PA	2026-08-21 00:52:11.974	t	t
cmt254xru0001lgl81uycllzq	cmsqww9qj0003m4q8135x6e7z	https://fcm.googleapis.com/fcm/send/d6bYzrF_Juk:APA91bFvyMgUDrAY4KeY0W0ZXTTZPNP9Iq27DDxoBbfcR_aZlBX7wUfaJ5dZfSMJkPQwYghILVbgl1tR1SHNen2nY7C7H2sZnZ8SVSgfVOyuRQ_-P75lgab5ytBZAgqxm4F88yWqunAI	BJaqBgBdt0cLpASDQ2zrXTllZCbjlL8xWKHb2rLVCSBaolAYWl769rFBpvlM53AG_ZQ3eatccOLkFw8Qqpe2mzI	gJ-bwiIv0zkJbLydGssHlw	2026-08-20 23:17:38.63	t	t
\.
...
cmtc6mcyo000eozjwk7bjdi8s	cmtc34o1p0001r0ihw4te4lbt	¿Se puede apagar el auto wake solo para un cliente específico?	f	2026-08-27 23:56:52.896	Es una excelente pregunta 🤔. Sin embargo, no tengo información exacta que confirme si esa configuración de *Auto-Wake* se puede personalizar por cliente específico o si es una regla general para toda tu cuenta.\n\nPara no darte información incorrecta, ¿te gustaría que te transfiera con uno de nuestros asesores para que te confirme este detalle con precisión?	cmtc34o1p0002r0ihmo6geaem
\.
...
cmtiz3v0c001dugbvm7xrzz4p	50360545592	cmsrzknn30003in22zrate8g2	m8d7vhl7lvhiendqnulktm3vqo	2025-09-05	19:00	20:00	Sebastian Recinos**	2026-09-01 18:00:55.741	2026-09-01 18:00:55.741
\.
...
wamid.HBgLMTMwNTc0ODE4NzAVAgASGBQzQUExN0Q2MENBRjc3RDIxQjMzOQA=	whatsapp	{"entry": [{"id": "1904825813528568", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "13057481870", "profile": {"name": "Sof Hasfura"}, "user_id": "US.1559673535829251"}], "messages": [{"id": "wamid.HBgLMTMwNTc0ODE4NzAVAgASGBQzQUExN0Q2MENBRjc3RDIxQjMzOQA=", "from": "13057481870", "type": "button", "button": {"text": "Si, confirmo", "payload": "Si, confirmo"}, "context": {"id": "wamid.HBgLMTMwNTc0ODE4NzAVAgARGBI0ODU0MzZGRkM2MTNERUQ0QzUA", "from": "50378975033"}, "timestamp": "1786931200", "from_user_id": "US.1559673535829251"}], "metadata": {"phone_number_id": "1191842234017105", "display_phone_number": "50378975033"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-17 01:46:43.155
1767001538079280-1786989950-59e5bf03	whatsapp	{"entry": [{"id": "1767001538079280", "time": 1786989950, "changes": [{"field": "account_update", "value": {"event": "BUSINESS_VERIFICATION_STATUS_UPDATE", "business_verification_status": "BUSINESS_REJECTED"}}]}], "object": "whatsapp_business_account"}	2026-08-17 18:05:52.346
wamid.HBgLMTMwNTc0ODE4NzAVAgARGBI2RTdCODRDNDVFNERCREZFQUYA-sent	whatsapp	{"entry": [{"id": "1904825813528568", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "13057481870", "user_id": "US.1559673535829251"}], "metadata": {"phone_number_id": "1191842234017105", "display_phone_number": "50378975033"}, "statuses": [{"id": "wamid.HBgLMTMwNTc0ODE4NzAVAgARGBI2RTdCODRDNDVFNERCREZFQUYA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1786996494", "recipient_id": "13057481870", "recipient_user_id": "US.1559673535829251"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-17 19:54:56.072
wamid.HBgLMTMwNTc0ODE4NzAVAgARGBI2RTdCODRDNDVFNERCREZFQUYA-delivered	whatsapp	{"entry": [{"id": "1904825813528568", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "13057481870", "user_id": "US.1559673535829251"}], "metadata": {"phone_number_id": "1191842234017105", "display_phone_number": "50378975033"}, "statuses": [{"id": "wamid.HBgLMTMwNTc0ODE4NzAVAgARGBI2RTdCODRDNDVFNERCREZFQUYA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1786996495", "recipient_id": "13057481870", "recipient_user_id": "US.1559673535829251"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-17 19:54:56.593
wamid.HBgLMTMwNTc0ODE4NzAVAgASGBQzQTI2OTFCODAwNDIzMTRFNjNDMwA=	whatsapp	{"entry": [{"id": "1904825813528568", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "13057481870", "profile": {"name": "Sof Hasfura"}, "user_id": "US.1559673535829251"}], "messages": [{"id": "wamid.HBgLMTMwNTc0ODE4NzAVAgASGBQzQTI2OTFCODAwNDIzMTRFNjNDMwA=", "from": "13057481870", "text": {"body": "Habia confirmado en otro chat"}, "type": "text", "timestamp": "1786996533", "from_user_id": "US.1559673535829251"}], "metadata": {"phone_number_id": "1191842234017105", "display_phone_number": "50378975033"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-17 19:55:34.469
wamid.HBgLMTMwNTc0ODE4NzAVAgASGBQzQTVEMURBQ0ZCNUFGRjA1QkFBMgA=	whatsapp	{"entry": [{"id": "1904825813528568", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "13057481870", "profile": {"name": "Sof Hasfura"}, "user_id": "US.1559673535829251"}], "messages": [{"id": "wamid.HBgLMTMwNTc0ODE4NzAVAgASGBQzQTVEMURBQ0ZCNUFGRjA1QkFBMgA=", "from": "13057481870", "text": {"body": "Pero queria recnfirmar"}, "type": "text", "timestamp": "1786996544", "from_user_id": "US.1559673535829251"}], "metadata": {"phone_number_id": "1191842234017105", "display_phone_number": "50378975033"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-17 19:55:45.797
934708762679830-1786996702-72c9a815	whatsapp	{"entry": [{"id": "934708762679830", "time": 1786996702, "changes": [{"field": "account_update", "value": {"event": "PARTNER_APP_INSTALLED", "waba_info": {"waba_id": "1767001538079280", "partner_app_id": "925464610263266", "owner_business_id": "1757911748145947"}}}]}], "object": "whatsapp_business_account"}	2026-08-17 19:58:23.689
934708762679830-1786996702-9e1c31af	whatsapp	{"entry": [{"id": "934708762679830", "time": 1786996702, "changes": [{"field": "account_update", "value": {"event": "MM_LITE_TERMS_SIGNED", "waba_info": {"waba_id": "1767001538079280", "owner_business_id": "1757911748145947"}}}]}], "object": "whatsapp_business_account"}	2026-08-17 19:58:23.751
wamid.HBgLNTAzNzU1ODgyODAVAgASGBQzQTU2M0VGMzJCNTMwOEY4NkFBQgA=	whatsapp	{"entry": [{"id": "1904825813528568", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50375588280", "profile": {"name": "Mauri Mena"}, "user_id": "SV.1453419296820066"}], "messages": [{"id": "wamid.HBgLNTAzNzU1ODgyODAVAgASGBQzQTU2M0VGMzJCNTMwOEY4NkFBQgA=", "from": "50375588280", "type": "button", "button": {"text": "Si, confirmo", "payload": "Si, confirmo"}, "context": {"id": "wamid.HBgLNTAzNzU1ODgyODAVAgARGBJCNDcwRjU4RTI3QzE5NDUwNEYA", "from": "50378975033"}, "timestamp": "1787022353", "from_user_id": "SV.1453419296820066"}], "metadata": {"phone_number_id": "1191842234017105", "display_phone_number": "50378975033"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-18 03:05:56.831
1767001538079280-1787079865-be227bd2	whatsapp	{"entry": [{"id": "1767001538079280", "time": 1787079865, "changes": [{"field": "message_template_status_update", "value": {"event": "APPROVED", "reason": "NONE", "message_template_id": 1571078271088544, "message_template_name": "handoff_notif_abitaai", "message_template_category": "UTILITY", "message_template_language": "es"}}]}], "object": "whatsapp_business_account"}	2026-08-18 19:04:26.272
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzc5NzBCRjc5QzQ0REZDOEVEQjJCOTg1QzU4QUVGRAA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzc5NzBCRjc5QzQ0REZDOEVEQjJCOTg1QzU4QUVGRAA=", "from": "50376003378", "text": {"body": "Hola"}, "type": "text", "timestamp": "1787103619", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 01:40:22.262
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIxRjU0RUI2MTE2OEZEMjcwNjMA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIxRjU0RUI2MTE2OEZEMjcwNjMA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787103638", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 01:40:39.339
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIxRjU0RUI2MTE2OEZEMjcwNjMA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIxRjU0RUI2MTE2OEZEMjcwNjMA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787103639", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 01:40:40.404
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzREMUYxNzI4REZCMTczOTUyNDUxRTI4NjlGQjczNQA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzREMUYxNzI4REZCMTczOTUyNDUxRTI4NjlGQjczNQA=", "from": "50376003378", "text": {"body": "Quiero saber mas info de melto"}, "type": "text", "timestamp": "1787103654", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 01:40:55.362
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI3OTIwNUE5MTA5RkMxOUZCMkYA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI3OTIwNUE5MTA5RkMxOUZCMkYA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787103697", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 01:41:38.339
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJERjM4NjEyQzVCNUYxQ0M4RkIA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJERjM4NjEyQzVCNUYxQ0M4RkIA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787103671", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 01:41:12.043
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzk3OTFCMTE5MzdEMzk2NTU2QjgyQkM2RjRDNTZEMQA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzk3OTFCMTE5MzdEMzk2NTU2QjgyQkM2RjRDNTZEMQA=", "from": "50376003378", "text": {"body": "Sabores"}, "type": "text", "timestamp": "1787103681", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 01:41:23.003
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzJGNDMxREY1NzM0NTg4QkQwQjA3QjdFMUI4QjJEOQA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzJGNDMxREY1NzM0NTg4QkQwQjA3QjdFMUI4QjJEOQA=", "from": "50376003378", "text": {"body": "Vainilla"}, "type": "text", "timestamp": "1787103713", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 01:41:54.318
wamid.HBgLNTAzNzU1ODI4NjAVAgARGBJGRTg0NkZFQTI3ODZEQUIzNDYA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50375582860", "user_id": "SV.1369872035047009"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzU1ODI4NjAVAgARGBJGRTg0NkZFQTI3ODZEQUIzNDYA", "status": "sent", "pricing": {"type": "regular", "billable": true, "category": "utility", "pricing_model": "PMP"}, "timestamp": "1787103734", "recipient_id": "50375582860", "recipient_user_id": "SV.1369872035047009"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 01:42:16.205
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJERjM4NjEyQzVCNUYxQ0M4RkIA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJERjM4NjEyQzVCNUYxQ0M4RkIA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787103671", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 01:41:12.12
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI3OTIwNUE5MTA5RkMxOUZCMkYA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI3OTIwNUE5MTA5RkMxOUZCMkYA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787103697", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 01:41:38.499
wamid.HBgLNTAzNzU1ODI4NjAVAgARGBJGRTg0NkZFQTI3ODZEQUIzNDYA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50375582860", "user_id": "SV.1369872035047009"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzU1ODI4NjAVAgARGBJGRTg0NkZFQTI3ODZEQUIzNDYA", "status": "delivered", "pricing": {"type": "regular", "billable": true, "category": "utility", "pricing_model": "PMP"}, "timestamp": "1787103736", "recipient_id": "50375582860", "recipient_user_id": "SV.1369872035047009"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 01:42:17.782
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzVFNEY5MDM1QzczNUUzREY2NDk0MTQ2MEE5NEUyRgA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzVFNEY5MDM1QzczNUUzREY2NDk0MTQ2MEE5NEUyRgA=", "from": "50376003378", "text": {"body": "Hola?"}, "type": "text", "timestamp": "1787104042", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 01:47:24.179
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIzMzA5N0QwQTUyQjA3RjM1ODYA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIzMzA5N0QwQTUyQjA3RjM1ODYA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787104052", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 01:47:32.884
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIzMzA5N0QwQTUyQjA3RjM1ODYA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIzMzA5N0QwQTUyQjA3RjM1ODYA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787104052", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 01:47:33.935
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQ0NFQUEwQ0Q5NzdDMUNGQjQzQjA4NjgzQ0U2NUZEOAA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQ0NFQUEwQ0Q5NzdDMUNGQjQzQjA4NjgzQ0U2NUZEOAA=", "from": "50376003378", "text": {"body": "Quiero un sorbete"}, "type": "text", "timestamp": "1787105266", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:07:48.139
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIyQkNCREU1OUQzREFBNUFERDQA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIyQkNCREU1OUQzREFBNUFERDQA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787105310", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:08:31.055
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzVENTVBMzc5QTMxRDYzN0ZFMTM3QTIwQ0Y4MUJEMgA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzVENTVBMzc5QTMxRDYzN0ZFMTM3QTIwQ0Y4MUJEMgA=", "from": "50376003378", "text": {"body": "Cafe"}, "type": "text", "timestamp": "1787105336", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:08:57.441
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQ0I2MDdFMDAzRTdDNjAyMzU4RjkzQUJGMzI2N0JCMQA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQ0I2MDdFMDAzRTdDNjAyMzU4RjkzQUJGMzI2N0JCMQA=", "from": "50376003378", "text": {"body": "Que es eso?"}, "type": "text", "timestamp": "1787104446", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 01:54:07.539
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI1NkFFMTkyQUMzMEJFNzdEMzQA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI1NkFFMTkyQUMzMEJFNzdEMzQA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787104461", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 01:54:22.081
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI1NkFFMTkyQUMzMEJFNzdEMzQA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI1NkFFMTkyQUMzMEJFNzdEMzQA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787104461", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 01:54:22.421
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzE3MDc3QTQ1RUFEN0E0QkFDQjc5MUM4Njg3MDVGRAA=	whatsapp	{"entry": [{"id": "1904825813528568", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.892866800532812"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzE3MDc3QTQ1RUFEN0E0QkFDQjc5MUM4Njg3MDVGRAA=", "from": "50376003378", "text": {"body": "."}, "type": "text", "timestamp": "1787105120", "from_user_id": "SV.892866800532812"}], "metadata": {"phone_number_id": "1191842234017105", "display_phone_number": "50378975033"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:05:23.516
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIyMzA1Q0NFQzk2QkJCQUYyQjUA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIyMzA1Q0NFQzk2QkJCQUYyQjUA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787105264", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:07:46.098
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIyMzA1Q0NFQzk2QkJCQUYyQjUA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIyMzA1Q0NFQzk2QkJCQUYyQjUA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787105265", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:07:46.525
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIzQTU0M0JFMzA4NEY5OUU2NTEA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIzQTU0M0JFMzA4NEY5OUU2NTEA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787105279", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:07:59.98
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIzQTU0M0JFMzA4NEY5OUU2NTEA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIzQTU0M0JFMzA4NEY5OUU2NTEA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787105279", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:08:00.096
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQ0VDQUQ3REI3MURFMjI1NDFDMUJDMUI2NkQ5MjJCQwA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQ0VDQUQ3REI3MURFMjI1NDFDMUJDMUI2NkQ5MjJCQwA=", "from": "50376003378", "text": {"body": "Que sabores tienen?"}, "type": "text", "timestamp": "1787105294", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:08:15.443
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQ0QxQkI1NkZGQkY0MkJDNEI1NDJCRjIzQkJFNkI0NgA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQ0QxQkI1NkZGQkY0MkJDNEI1NDJCRjIzQkJFNkI0NgA=", "from": "50376003378", "text": {"body": "Hola?"}, "type": "text", "timestamp": "1787105400", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:10:01.849
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJEOUVBODMxQTUyNzk0NDBFNzUA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJEOUVBODMxQTUyNzk0NDBFNzUA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787105412", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:10:13.144
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI1QjhGQjAzNkE5NjgzRDQzRTEA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI1QjhGQjAzNkE5NjgzRDQzRTEA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787105712", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:15:13.705
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJBMjVGRDZENjcxOTlCM0FFRDgA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJBMjVGRDZENjcxOTlCM0FFRDgA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787105745", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:15:46.44
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIyRjc4QzAyQ0JGQTdDODlCQzIA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIyRjc4QzAyQ0JGQTdDODlCQzIA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "utility", "pricing_model": "PMP"}, "timestamp": "1787105791", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:16:32.207
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIyQkNCREU1OUQzREFBNUFERDQA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIyQkNCREU1OUQzREFBNUFERDQA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787105309", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:08:30.9
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI4NTUwMzEzOTY4ODJFNkMwRUUA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI4NTUwMzEzOTY4ODJFNkMwRUUA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "utility", "pricing_model": "PMP"}, "timestamp": "1787105355", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:09:16.214
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI1QjhGQjAzNkE5NjgzRDQzRTEA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI1QjhGQjAzNkE5NjgzRDQzRTEA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787105713", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:15:14.058
wamid.HBgLNTAzNzU1ODI4NjAVAgARGBI2OTQ3QzRFMTJEMjk5N0U1QTMA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50375582860", "user_id": "SV.1369872035047009"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzU1ODI4NjAVAgARGBI2OTQ3QzRFMTJEMjk5N0U1QTMA", "status": "sent", "pricing": {"type": "regular", "billable": true, "category": "utility", "pricing_model": "PMP"}, "timestamp": "1787105355", "recipient_id": "50375582860", "recipient_user_id": "SV.1369872035047009"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:09:16.041
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJEOUVBODMxQTUyNzk0NDBFNzUA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJEOUVBODMxQTUyNzk0NDBFNzUA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787105411", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:10:12.616
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzM0OUE0NERDNkI2N0ZCNEJBNDlBRDBGQTVDRTBFMwA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzM0OUE0NERDNkI2N0ZCNEJBNDlBRDBGQTVDRTBFMwA=", "from": "50376003378", "text": {"body": "Mejor otro sabor"}, "type": "text", "timestamp": "1787105673", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:14:34.859
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI5MzQ3RUI1NEYzQjg3MUZDOEQA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI5MzQ3RUI1NEYzQjg3MUZDOEQA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787105689", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:14:50.498
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI5MzQ3RUI1NEYzQjg3MUZDOEQA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI5MzQ3RUI1NEYzQjg3MUZDOEQA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787105690", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:14:51.409
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJBMjVGRDZENjcxOTlCM0FFRDgA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJBMjVGRDZENjcxOTlCM0FFRDgA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787105745", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:15:46.444
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI4NTUwMzEzOTY4ODJFNkMwRUUA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI4NTUwMzEzOTY4ODJFNkMwRUUA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "utility", "pricing_model": "PMP"}, "timestamp": "1787105355", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:09:16.17
wamid.HBgLNTAzNzU1ODI4NjAVAgARGBI2OTQ3QzRFMTJEMjk5N0U1QTMA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50375582860", "user_id": "SV.1369872035047009"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzU1ODI4NjAVAgARGBI2OTQ3QzRFMTJEMjk5N0U1QTMA", "status": "delivered", "pricing": {"type": "regular", "billable": true, "category": "utility", "pricing_model": "PMP"}, "timestamp": "1787105355", "recipient_id": "50375582860", "recipient_user_id": "SV.1369872035047009"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:09:16.726
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzQ3RDc0RjYyMkI3QkY1NEU2NURGRjAxQUE1NEQ3RQA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzQ3RDc0RjYyMkI3QkY1NEU2NURGRjAxQUE1NEQ3RQA=", "from": "50376003378", "text": {"body": "Vainilla"}, "type": "text", "timestamp": "1787105697", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:14:58.545
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQ0I0QUNGMEYwNEI5NzcwNjVDNTcyNThCQjZDMDc5MAA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQ0I0QUNGMEYwNEI5NzcwNjVDNTcyNThCQjZDMDc5MAA=", "from": "50376003378", "text": {"body": "Y que dias se puede pickup?"}, "type": "text", "timestamp": "1787105729", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:15:30.737
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQ0FCNDUwMjZGRTQ0NUJBOTlDNzczNDk5NjkwRDhGNwA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQ0FCNDUwMjZGRTQ0NUJBOTlDNzczNDk5NjkwRDhGNwA=", "from": "50376003378", "text": {"body": "Si me parece para el sabado"}, "type": "text", "timestamp": "1787105771", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:16:12.544
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIyRjc4QzAyQ0JGQTdDODlCQzIA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIyRjc4QzAyQ0JGQTdDODlCQzIA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "utility", "pricing_model": "PMP"}, "timestamp": "1787105790", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 02:16:31.912
1767001538079280-1787110051-3817a1ff	whatsapp	{"entry": [{"id": "1767001538079280", "time": 1787110051, "changes": [{"field": "account_update", "value": {"event": "BUSINESS_VERIFICATION_STATUS_UPDATE", "business_verification_status": "BUSINESS_REJECTED"}}]}], "object": "whatsapp_business_account"}	2026-08-19 03:27:32.701
wamid.HBgLNTAzNzg4Nzk1MzkVAgARGBIyMjBDOEQ3ODZDQkExODREODcA-read	whatsapp	{"entry": [{"id": "1904825813528568", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50378879539", "user_id": "SV.1805683487095530"}], "metadata": {"phone_number_id": "1191842234017105", "display_phone_number": "50378975033"}, "statuses": [{"id": "wamid.HBgLNTAzNzg4Nzk1MzkVAgARGBIyMjBDOEQ3ODZDQkExODREODcA", "status": "read", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787151451", "recipient_id": "50378879539", "recipient_user_id": "SV.1805683487095530"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-19 14:57:33.87
1767001538079280-1787172746-395473d8	whatsapp	{"entry": [{"id": "1767001538079280", "time": 1787172746, "changes": [{"field": "account_update", "value": {"event": "BUSINESS_VERIFICATION_STATUS_UPDATE", "business_verification_status": "BUSINESS_REJECTED"}}]}], "object": "whatsapp_business_account"}	2026-08-19 20:52:27.292
wamid.HBgLNTAzNzc0MjAwNjMVAgASGBQzQUZDMkQ4RDUyMzQyQjExQzA3NAA=	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50377420063", "profile": {"name": "Paulina Frech"}, "user_id": "SV.2176130622943396"}], "messages": [{"id": "wamid.HBgLNTAzNzc0MjAwNjMVAgASGBQzQUZDMkQ4RDUyMzQyQjExQzA3NAA=", "from": "50377420063", "text": {"body": "hola"}, "type": "text", "timestamp": "1787193153", "from_user_id": "SV.2176130622943396"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-20 02:32:36.632
wamid.HBgLNTAzNzc0MjAwNjMVAgARGBI0MDg1MTkyOTg2NEMwMzBERjIA-sent	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50377420063", "user_id": "SV.2176130622943396"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNzc0MjAwNjMVAgARGBI0MDg1MTkyOTg2NEMwMzBERjIA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787193174", "recipient_id": "50377420063", "recipient_user_id": "SV.2176130622943396"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-20 02:32:55.352
wamid.HBgLNTAzNzc0MjAwNjMVAgARGBI0MDg1MTkyOTg2NEMwMzBERjIA-delivered	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50377420063", "user_id": "SV.2176130622943396"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNzc0MjAwNjMVAgARGBI0MDg1MTkyOTg2NEMwMzBERjIA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787193176", "recipient_id": "50377420063", "recipient_user_id": "SV.2176130622943396"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-20 02:32:57.323
wamid.HBgLNTAzNzc0MjAwNjMVAgASGBQzQUQzNDkyRTI3REQ4NDE4NDA2OAA=	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50377420063", "profile": {"name": "Paulina Frech"}, "user_id": "SV.2176130622943396"}], "messages": [{"id": "wamid.HBgLNTAzNzc0MjAwNjMVAgASGBQzQUQzNDkyRTI3REQ4NDE4NDA2OAA=", "from": "50377420063", "text": {"body": "Mañana a las 9pm"}, "type": "text", "timestamp": "1787193194", "from_user_id": "SV.2176130622943396"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-20 02:33:16.046
wamid.HBgLNTAzNzc0MjAwNjMVAgARGBJDNjY4OTVERTFDN0UzNzRGQTcA-sent	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50377420063", "user_id": "SV.2176130622943396"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNzc0MjAwNjMVAgARGBJDNjY4OTVERTFDN0UzNzRGQTcA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787193220", "recipient_id": "50377420063", "recipient_user_id": "SV.2176130622943396"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-20 02:33:41.797
wamid.HBgLNTAzNzc0MjAwNjMVAgARGBJDNjY4OTVERTFDN0UzNzRGQTcA-delivered	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50377420063", "user_id": "SV.2176130622943396"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNzc0MjAwNjMVAgARGBJDNjY4OTVERTFDN0UzNzRGQTcA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787193221", "recipient_id": "50377420063", "recipient_user_id": "SV.2176130622943396"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-20 02:33:42.186
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzYxQUFENDQ4MUJCOTkzQTZGRTBEOUMzREIwOTkyRAA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzYxQUFENDQ4MUJCOTkzQTZGRTBEOUMzREIwOTkyRAA=", "from": "50376003378", "text": {"body": "Hola"}, "type": "text", "timestamp": "1787268763", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-20 23:32:46.638
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI5RUMwRjZCRDREOTgxMTQ3ODYA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI5RUMwRjZCRDREOTgxMTQ3ODYA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787268778", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-20 23:32:59.789
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI5RUMwRjZCRDREOTgxMTQ3ODYA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI5RUMwRjZCRDREOTgxMTQ3ODYA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787268779", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-20 23:33:00.683
wamid.HBgLNTAzNzYwMDMzNzgVAgASGBYzRUIwQzg5RDkwMjYwNDQ1REUyNTdFAA==	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGBYzRUIwQzg5RDkwMjYwNDQ1REUyNTdFAA==", "from": "50376003378", "text": {"body": "quiero hablar con un humano"}, "type": "text", "timestamp": "1787268826", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-20 23:33:47.915
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIwM0NBQzY2Nzc4QUJCMTREMUUA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIwM0NBQzY2Nzc4QUJCMTREMUUA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787268841", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-20 23:34:02.716
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIwM0NBQzY2Nzc4QUJCMTREMUUA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIwM0NBQzY2Nzc4QUJCMTREMUUA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787268841", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-20 23:34:02.886
wamid.HBgLMTgxMzYwNjAxMTEVAgASGBQzQTU5Njk3RTY3RjIxQzg0MzJBNwA=	whatsapp	{"entry": [{"id": "1904825813528568", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "18136060111", "profile": {"name": "Francisco"}, "user_id": "US.1071072755411230"}], "messages": [{"id": "wamid.HBgLMTgxMzYwNjAxMTEVAgASGBQzQTU5Njk3RTY3RjIxQzg0MzJBNwA=", "from": "18136060111", "type": "button", "button": {"text": "No, no podre asistir", "payload": "No, no podre asistir"}, "context": {"id": "wamid.HBgLMTgxMzYwNjAxMTEVAgARGBI1MDMzMUM2NDBBNEVGRjA0OEMA", "from": "50378975033"}, "timestamp": "1787268901", "from_user_id": "US.1071072755411230"}], "metadata": {"phone_number_id": "1191842234017105", "display_phone_number": "50378975033"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-20 23:35:04.084
wamid.HBgLNTAzNzYwMDMzNzgVAgASGBYzRUIwOTVEMUJGNzFERTNCNTA0RDlBAA==	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGBYzRUIwOTVEMUJGNzFERTNCNTA0RDlBAA==", "from": "50376003378", "text": {"body": "hola"}, "type": "text", "timestamp": "1787270177", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-20 23:56:19.297
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI5RDY3MzlGNUFBNTVGM0I4MDIA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI5RDY3MzlGNUFBNTVGM0I4MDIA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787270431", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-21 00:00:32.978
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI5RDY3MzlGNUFBNTVGM0I4MDIA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI5RDY3MzlGNUFBNTVGM0I4MDIA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787270431", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-21 00:00:33.347
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJGREFFMEI0MjFBMDAxQjdFMzIA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJGREFFMEI0MjFBMDAxQjdFMzIA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787270480", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-21 00:01:21.331
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJGREFFMEI0MjFBMDAxQjdFMzIA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJGREFFMEI0MjFBMDAxQjdFMzIA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787270480", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-21 00:01:21.771
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJEQkE5RTc2NDc1RkEzQ0U3NzUA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJEQkE5RTc2NDc1RkEzQ0U3NzUA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787270518", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-21 00:01:59.205
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJEQkE5RTc2NDc1RkEzQ0U3NzUA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJEQkE5RTc2NDc1RkEzQ0U3NzUA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787270518", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-21 00:01:59.586
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQ0QwQjg5OTQ4RTcxNTZFMTNEN0U1ODBGNTY0REVGOAA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQ0QwQjg5OTQ4RTcxNTZFMTNEN0U1ODBGNTY0REVGOAA=", "from": "50376003378", "text": {"body": "."}, "type": "text", "timestamp": "1787270535", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-21 00:02:16.579
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQ0Y2MUIyNUUwQzgyMjc0MENGODk1NjgwMjNDNTQxMwA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQ0Y2MUIyNUUwQzgyMjc0MENGODk1NjgwMjNDNTQxMwA=", "from": "50376003378", "text": {"body": "Prueba"}, "type": "text", "timestamp": "1787270782", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-21 00:06:24.086
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzFCNDBBMkQxQjQxQ0M3QzNFREZFQkE5RkRGQzFEQgA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzFCNDBBMkQxQjQxQ0M3QzNFREZFQkE5RkRGQzFEQgA=", "from": "50376003378", "type": "image", "image": {"id": "4435531403369450", "url": "https://lookaside.fbsbx.com/whatsapp_business/attachments/?mid=4435531403369450&source=webhook&ext=1787271114&hash=ATxVoKgVEDti0fR0mA5M0NvNAqBGl-5uAEsqAg1kwYo3vA", "sha256": "sMgKjnq2FEd3UOKA98/9qFh94Rk8kc/iko8Gv3C8bx0=", "caption": "Y le pone la burbujita y todo", "mime_type": "image/jpeg"}, "timestamp": "1787270812", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-21 00:06:55.536
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzlDMzk0MERBREJCREI5MDEzOUUyMDI5N0E4RTE2QQA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzlDMzk0MERBREJCREI5MDEzOUUyMDI5N0E4RTE2QQA=", "from": "50376003378", "text": {"body": "Hola"}, "type": "text", "timestamp": "1787273553", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-21 00:52:34.835
wamid.HBgLNTAzNzU1ODI4NjAVAgASGBQzQTg1MzQ0M0NDMzRFNUZCRDg1OQA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50375582860", "profile": {"name": "Gabriel Funes"}, "user_id": "SV.1369872035047009"}], "messages": [{"id": "wamid.HBgLNTAzNzU1ODI4NjAVAgASGBQzQTg1MzQ0M0NDMzRFNUZCRDg1OQA=", "from": "50375582860", "text": {"body": "Hola"}, "type": "text", "timestamp": "1787327494", "from_user_id": "SV.1369872035047009"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-21 15:51:36.315
wamid.HBgLNTAzNzU1ODI4NjAVAgARGBJGQkU2ODc5RDIwMkUyQzlDQzgA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50375582860", "user_id": "SV.1369872035047009"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzU1ODI4NjAVAgARGBJGQkU2ODc5RDIwMkUyQzlDQzgA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787327526", "recipient_id": "50375582860", "recipient_user_id": "SV.1369872035047009"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-21 15:52:07.346
wamid.HBgLNTAzNzU1ODI4NjAVAgARGBJGQkU2ODc5RDIwMkUyQzlDQzgA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50375582860", "user_id": "SV.1369872035047009"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzU1ODI4NjAVAgARGBJGQkU2ODc5RDIwMkUyQzlDQzgA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787327528", "recipient_id": "50375582860", "recipient_user_id": "SV.1369872035047009"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-21 15:52:09.927
wamid.HBgLNTAzNzU1ODI4NjAVAgASGBQzQTlFMEIzRkFEN0FGNjcyQkNGOQA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50375582860", "profile": {"name": "Gabriel Funes"}, "user_id": "SV.1369872035047009"}], "messages": [{"id": "wamid.HBgLNTAzNzU1ODI4NjAVAgASGBQzQTlFMEIzRkFEN0FGNjcyQkNGOQA=", "from": "50375582860", "text": {"body": "Jiji"}, "type": "text", "timestamp": "1787327793", "from_user_id": "SV.1369872035047009"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-21 15:56:35.131
wamid.HBgLNTAzNzU1ODI4NjAVAgASGBQzQUMxNDY1MkJGRTUxOTQyRjIxMAA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50375582860", "profile": {"name": "Gabriel Funes"}, "user_id": "SV.1369872035047009"}], "messages": [{"id": "wamid.HBgLNTAzNzU1ODI4NjAVAgASGBQzQUMxNDY1MkJGRTUxOTQyRjIxMAA=", "from": "50375582860", "text": {"body": "Ta vergon"}, "type": "text", "timestamp": "1787327795", "from_user_id": "SV.1369872035047009"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-21 15:56:36.454
wamid.HBgLNTAzNzU1ODI4NjAVAgASGBQzQTlDNERCNTIyMzcxNTZCMDdCRAA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50375582860", "profile": {"name": "Gabriel Funes"}, "user_id": "SV.1369872035047009"}], "messages": [{"id": "wamid.HBgLNTAzNzU1ODI4NjAVAgASGBQzQTlDNERCNTIyMzcxNTZCMDdCRAA=", "from": "50375582860", "text": {"body": "Hoal hola"}, "type": "text", "timestamp": "1787328686", "from_user_id": "SV.1369872035047009"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-21 16:11:27.82
1767001538079280-1787347308-021e5389	whatsapp	{"entry": [{"id": "1767001538079280", "time": 1787347308, "changes": [{"field": "account_update", "value": {"event": "BUSINESS_VERIFICATION_STATUS_UPDATE", "business_verification_status": "BUSINESS_VERIFIED"}}]}], "object": "whatsapp_business_account"}	2026-08-21 21:21:49.834
1767001538079280-1787347339-4cf01620	whatsapp	{"entry": [{"id": "1767001538079280", "time": 1787347339, "changes": [{"field": "business_capability_update", "value": {"max_phone_numbers_per_waba": 25, "max_daily_conversation_per_phone": 250, "max_daily_conversations_per_business": "TIER_250"}}]}], "object": "whatsapp_business_account"}	2026-08-21 21:22:20.387
1767001538079280-1787347620-554fb142	whatsapp	{"entry": [{"id": "1767001538079280", "time": 1787347620, "changes": [{"field": "business_capability_update", "value": {"max_phone_numbers_per_waba": 25, "max_daily_conversation_per_phone": 250, "max_daily_conversations_per_business": "TIER_250"}}]}], "object": "whatsapp_business_account"}	2026-08-21 21:27:01.815
wamid.HBgLNTAzNzYwMDMzNzgVAgASGBYzRUIwMEI4OUZGQUEwNjJFNzVCNkE2AA==	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGBYzRUIwMEI4OUZGQUEwNjJFNzVCNkE2AA==", "from": "50376003378", "text": {"body": "."}, "type": "text", "timestamp": "1787362246", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 01:30:48.427
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIzRENGMUVFNEQ4NkIxRDE4OUQA-failed	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBIzRENGMUVFNEQ4NkIxRDE4OUQA", "errors": [{"code": 131053, "title": "Media upload error", "message": "Media upload error", "error_data": {"details": "Unsupported Audio mime type audio/webm. Please use one of audio/ogg; codecs=opus, audio/mpeg, audio/amr, audio/mp4, audio/aac."}}], "status": "failed", "timestamp": "1787362274", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 01:31:15.889
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI5MEZBNDNDNkNEQzhDNDU5MzkA-failed	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI5MEZBNDNDNkNEQzhDNDU5MzkA", "errors": [{"code": 131053, "title": "Media upload error", "message": "Media upload error", "error_data": {"details": "Audio file uploaded with mimetype as audio/mp4, however on processing it is of type application/octet-stream. Please choose a different file."}}], "status": "failed", "timestamp": "1787362724", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 01:38:45.444
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJEMDc1MDQxRUEwM0M0QkFGNDkA-failed	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJEMDc1MDQxRUEwM0M0QkFGNDkA", "errors": [{"code": 131053, "title": "Media upload error", "message": "Media upload error", "error_data": {"details": "Audio file uploaded with mimetype as audio/mp4, however on processing it is of type application/octet-stream. Please choose a different file."}}], "status": "failed", "timestamp": "1787363191", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 01:46:33.296
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI1QzlGRkM4NDZFMUREQzE2RjgA-failed	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI1QzlGRkM4NDZFMUREQzE2RjgA", "errors": [{"code": 131053, "title": "Media upload error", "message": "Media upload error", "error_data": {"details": "Audio file uploaded with mimetype as audio/mp4, however on processing it is of type application/octet-stream. Please choose a different file."}}], "status": "failed", "timestamp": "1787363672", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 01:54:33.949
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJBMDdEMTY3NzA2ODNBMUZGMjQA-failed	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJBMDdEMTY3NzA2ODNBMUZGMjQA", "errors": [{"code": 131053, "title": "Media upload error", "message": "Media upload error", "error_data": {"details": "Audio file uploaded with mimetype as audio/mp4, however on processing it is of type application/octet-stream. Please choose a different file."}}], "status": "failed", "timestamp": "1787363932", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 01:58:54.07
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI4NkMwMzc2OTQ3QUIyMDc1MzQA-failed	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI4NkMwMzc2OTQ3QUIyMDc1MzQA", "errors": [{"code": 131053, "title": "Media upload error", "message": "Media upload error", "error_data": {"details": "Audio file uploaded with mimetype as audio/mp4, however on processing it is of type application/octet-stream. Please choose a different file."}}], "status": "failed", "timestamp": "1787364197", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 02:03:18.285
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJCQzAzQ0E5RjAyODI0QkFBQzEA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJCQzAzQ0E5RjAyODI0QkFBQzEA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787365171", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 02:19:32.846
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJCQzAzQ0E5RjAyODI0QkFBQzEA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJCQzAzQ0E5RjAyODI0QkFBQzEA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787365172", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 02:19:33.651
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJFRTEyQkMxRURDRjJGQzdGOTIA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJFRTEyQkMxRURDRjJGQzdGOTIA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787366187", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 02:36:29.241
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJFRTEyQkMxRURDRjJGQzdGOTIA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJFRTEyQkMxRURDRjJGQzdGOTIA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787366186", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 02:36:28.981
1767001538079280-1787426118-f8cd4d5a	whatsapp	{"entry": [{"id": "1767001538079280", "time": 1787426118, "changes": [{"field": "phone_number_name_update", "value": {"decision": "REJECTED", "rejection_reason": "BIZ_COMMERCE_VIOLATION_OTHER", "display_phone_number": "50368488314", "requested_verified_name": "Roof Ball"}}]}], "object": "whatsapp_business_account"}	2026-08-22 19:15:19.91
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI1RTBGOUY5MzJBRDQ0NzkzMzAA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI1RTBGOUY5MzJBRDQ0NzkzMzAA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787428561", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 19:56:02.535
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI1RTBGOUY5MzJBRDQ0NzkzMzAA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI1RTBGOUY5MzJBRDQ0NzkzMzAA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787428561", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 19:56:02.842
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJFQjExQTk2RTAwNDhCRjFGNTcA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJFQjExQTk2RTAwNDhCRjFGNTcA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787429097", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 20:04:58.78
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJFQjExQTk2RTAwNDhCRjFGNTcA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJFQjExQTk2RTAwNDhCRjFGNTcA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787429097", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 20:04:59.07
wamid.HBgLNTAzNzU1ODI4NjAVAgASGBQzQTQ5NTM0MzY0RkZDREREMTQxMwA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50375582860", "profile": {"name": "Gabriel Funes"}, "user_id": "SV.1369872035047009"}], "messages": [{"id": "wamid.HBgLNTAzNzU1ODI4NjAVAgASGBQzQTQ5NTM0MzY0RkZDREREMTQxMwA=", "from": "50375582860", "text": {"body": "Prueba"}, "type": "text", "timestamp": "1787429956", "from_user_id": "SV.1369872035047009"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 20:19:19.159
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQ0FGODU1QkM1MEU4NDM2NTdCOTFBQTRBQjcwRTU5QgA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQ0FGODU1QkM1MEU4NDM2NTdCOTFBQTRBQjcwRTU5QgA=", "from": "50376003378", "type": "audio", "audio": {"id": "1540625690595730", "url": "https://lookaside.fbsbx.com/whatsapp_business/attachments/?mid=1540625690595730&source=webhook&ext=1787429600&hash=ATz2SZAA9a_Ij05aTZO__7r4g8WMApgnV-2QKGz7cVIthA", "voice": true, "sha256": "KlAN736iJAmrwtHY3Deb3jMJEyuKvyalWHmZHFQgotY=", "mime_type": "audio/ogg; codecs=opus"}, "timestamp": "1787429299", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 20:08:21.249
wamid.HBgLNTAzNzU1ODI4NjAVAgARGBJBQzFDNDA4RTU4RkEzMzY4MDQA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50375582860", "user_id": "SV.1369872035047009"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzU1ODI4NjAVAgARGBJBQzFDNDA4RTU4RkEzMzY4MDQA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787430032", "recipient_id": "50375582860", "recipient_user_id": "SV.1369872035047009"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 20:20:33.84
wamid.HBgLNTAzNzU1ODI4NjAVAgASGBQzQTc3MzUzOTdDNURBM0UxNDQ0QQA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50375582860", "profile": {"name": "Gabriel Funes"}, "user_id": "SV.1369872035047009"}], "messages": [{"id": "wamid.HBgLNTAzNzU1ODI4NjAVAgASGBQzQTc3MzUzOTdDNURBM0UxNDQ0QQA=", "from": "50375582860", "text": {"body": "Esooooo"}, "type": "text", "timestamp": "1787430237", "from_user_id": "SV.1369872035047009"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 20:23:58.9
wamid.HBgLNTAzNzU1ODI4NjAVAgASGBQzQThDQjk5MzkwNDY3NjhEMDQyNQA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50375582860", "profile": {"name": "Gabriel Funes"}, "user_id": "SV.1369872035047009"}], "messages": [{"id": "wamid.HBgLNTAzNzU1ODI4NjAVAgASGBQzQThDQjk5MzkwNDY3NjhEMDQyNQA=", "from": "50375582860", "text": {"body": "Wings wings"}, "type": "text", "timestamp": "1787429960", "from_user_id": "SV.1369872035047009"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 20:19:21.199
wamid.HBgLNTAzNzU1ODI4NjAVAgARGBJBQzFDNDA4RTU4RkEzMzY4MDQA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50375582860", "user_id": "SV.1369872035047009"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzU1ODI4NjAVAgARGBJBQzFDNDA4RTU4RkEzMzY4MDQA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787430032", "recipient_id": "50375582860", "recipient_user_id": "SV.1369872035047009"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 20:20:32.834
wamid.HBgLNTAzNzU1ODI4NjAVAgASGBQzQTdDNEE5Qjg1NDlBNTZBOUYxNgA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50375582860", "profile": {"name": "Gabriel Funes"}, "user_id": "SV.1369872035047009"}], "messages": [{"id": "wamid.HBgLNTAzNzU1ODI4NjAVAgASGBQzQTdDNEE5Qjg1NDlBNTZBOUYxNgA=", "from": "50375582860", "type": "sticker", "sticker": {"id": "1940554683306339", "url": "https://lookaside.fbsbx.com/whatsapp_business/attachments/?mid=1940554683306339&source=webhook&ext=1787430537&hash=ATzqoNWIdElfrQPkHMpnv40v2S_FyoQ3K1F3ZwE8xHejzA", "sha256": "i+NGiDDXHXgumNRh15QFyN1p3GHz1u7FpchD0sAVnnw=", "animated": true, "mime_type": "image/webp"}, "timestamp": "1787430236", "from_user_id": "SV.1369872035047009"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-22 20:23:58.053
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzMxRkY2RjBGMkQzRjRDMTYwNDczQkNBRUNGRkE1NAA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.1369873051713574"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzMxRkY2RjBGMkQzRjRDMTYwNDczQkNBRUNGRkE1NAA=", "from": "50376003378", "type": "sticker", "sticker": {"id": "2929746877387473", "url": "https://lookaside.fbsbx.com/whatsapp_business/attachments/?mid=2929746877387473&source=webhook&ext=1787457002&hash=ATwNI-0GTbE28riB3gs9bpTKceIUqMTvqIe5exjNH7D4Qw", "sha256": "RSi6y8Clh2WNPk2jVHIi25X7p+tN7/BI0/mlbBhEIdc=", "animated": true, "mime_type": "image/webp"}, "timestamp": "1787456699", "from_user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-23 03:45:03.828
wamid.HBgLNTAzNzU1ODI4NjAVAgASGBQzQTlGQjg0REZDRTFBMDJCOTg1QQA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50375582860", "profile": {"name": "Gabriel Funes"}, "user_id": "SV.1369872035047009"}], "messages": [{"id": "wamid.HBgLNTAzNzU1ODI4NjAVAgASGBQzQTlGQjg0REZDRTFBMDJCOTg1QQA=", "from": "50375582860", "type": "sticker", "sticker": {"id": "2692890497779083", "url": "https://lookaside.fbsbx.com/whatsapp_business/attachments/?mid=2692890497779083&source=webhook&ext=1787457671&hash=ATzYgKVSQTQCEkdeKKPKnXYDaMuKWenRjKhmQRk5qeed6A", "sha256": "/PF+hDCluK/1/l9uNElwBupY1EvZPsj6RNZDsfG4HuY=", "animated": true, "mime_type": "image/webp"}, "timestamp": "1787457369", "from_user_id": "SV.1369872035047009"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-23 03:56:13.015
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJBM0QzODJDRjFCRURDRkE3NEIA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJBM0QzODJDRjFCRURDRkE3NEIA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787538978", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-24 02:36:20.024
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJBM0QzODJDRjFCRURDRkE3NEIA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBJBM0QzODJDRjFCRURDRkE3NEIA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787538979", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-24 02:36:21.232
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI0ODc5MDZCN0U2QzU4RUU2MEMA-sent	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI0ODc5MDZCN0U2QzU4RUU2MEMA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787539570", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-24 02:46:11.398
wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI0ODc5MDZCN0U2QzU4RUU2MEMA-delivered	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "user_id": "SV.1369873051713574"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "statuses": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgARGBI0ODc5MDZCN0U2QzU4RUU2MEMA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787539570", "recipient_id": "50376003378", "recipient_user_id": "SV.1369873051713574"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-24 02:46:11.856
wamid.HBgLMTc4NjQzMTc3MDUVAgARGBI4QzYwOTEyRDY5NTVBOTUzQTUA-read	whatsapp	{"entry": [{"id": "1904825813528568", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "17864317705", "user_id": "US.1586564873481334"}], "metadata": {"phone_number_id": "1191842234017105", "display_phone_number": "50378975033"}, "statuses": [{"id": "wamid.HBgLMTc4NjQzMTc3MDUVAgARGBI4QzYwOTEyRDY5NTVBOTUzQTUA", "status": "read", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1787636591", "recipient_id": "17864317705", "recipient_user_id": "US.1586564873481334"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-25 05:43:14.192
wamid.HBgLMTc4NjQzMTc3MDUVAgARGBI1OUFEM0M4QUMyNzM1N0MyRDAA-read	whatsapp	{"entry": [{"id": "1904825813528568", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "17864317705", "user_id": "US.1586564873481334"}], "metadata": {"phone_number_id": "1191842234017105", "display_phone_number": "50378975033"}, "statuses": [{"id": "wamid.HBgLMTc4NjQzMTc3MDUVAgARGBI1OUFEM0M4QUMyNzM1N0MyRDAA", "status": "read", "pricing": {"type": "regular", "billable": true, "category": "utility", "pricing_model": "PMP"}, "timestamp": "1787636591", "recipient_id": "17864317705", "recipient_user_id": "US.1586564873481334"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-25 05:43:14.364
1767001538079280-1787836764-b801f8d2	whatsapp	{"entry": [{"id": "1767001538079280", "time": 1787836764, "changes": [{"field": "phone_number_name_update", "value": {"decision": "REJECTED", "rejection_reason": "BIZ_COMMERCE_VIOLATION_OTHER", "display_phone_number": "50368488314", "requested_verified_name": "Roofball"}}]}], "object": "whatsapp_business_account"}	2026-08-27 13:19:25.442
wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzY1QkExRTY3RkNGOTY0M0IyRkM2MUEzNkM1Q0FCOQA=	whatsapp	{"entry": [{"id": "1904825813528568", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50376003378", "profile": {"name": "DA"}, "user_id": "SV.892866800532812"}], "messages": [{"id": "wamid.HBgLNTAzNzYwMDMzNzgVAgASGCBBQzY1QkExRTY3RkNGOTY0M0IyRkM2MUEzNkM1Q0FCOQA=", "from": "50376003378", "text": {"body": "Hola"}, "type": "text", "timestamp": "1787857295", "from_user_id": "SV.892866800532812"}], "metadata": {"phone_number_id": "1191842234017105", "display_phone_number": "50378975033"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-27 19:01:38.25
wamid.HBgLNTAzNzg1MDQyNDgVAgASGBQzQTQyQUNBNTQzNjQxNDVBRUY4OAA=	whatsapp	{"entry": [{"id": "1904825813528568", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50378504248", "profile": {"name": "Eileen"}, "user_id": "SV.1095703099454641"}], "messages": [{"id": "wamid.HBgLNTAzNzg1MDQyNDgVAgASGBQzQTQyQUNBNTQzNjQxNDVBRUY4OAA=", "from": "50378504248", "type": "button", "button": {"text": "No, no podre asistir", "payload": "No, no podre asistir"}, "context": {"id": "wamid.HBgLNTAzNzg1MDQyNDgVAgARGBI2NjNFQUNEMzlFOTJDODNBRTAA", "from": "50378975033"}, "timestamp": "1787871408", "from_user_id": "SV.1095703099454641"}], "metadata": {"phone_number_id": "1191842234017105", "display_phone_number": "50378975033"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-27 22:56:50.225
wamid.HBgLNTAzNzg1MDQyNDgVAgASGBQzQTQ2RkFDRkUxMjY1NkRGQUVBQgA=	whatsapp	{"entry": [{"id": "1904825813528568", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50378504248", "profile": {"name": "Eileen"}, "user_id": "SV.1095703099454641"}], "messages": [{"id": "wamid.HBgLNTAzNzg1MDQyNDgVAgASGBQzQTQ2RkFDRkUxMjY1NkRGQUVBQgA=", "from": "50378504248", "text": {"body": "Me disculpo pues me acaban  de programar una cirugia para el viernes 4 de septiembre"}, "type": "text", "timestamp": "1787871491", "from_user_id": "SV.1095703099454641"}], "metadata": {"phone_number_id": "1191842234017105", "display_phone_number": "50378975033"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-27 22:58:13.48
wamid.HBgLNTAzNzg4NzAwNDIVAgARGBI5NkFDMTQ4NDE5MTRDMDVGNzMA-read	whatsapp	{"entry": [{"id": "1904825813528568", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50378870042", "user_id": "SV.3447949385373678"}], "metadata": {"phone_number_id": "1191842234017105", "display_phone_number": "50378975033"}, "statuses": [{"id": "wamid.HBgLNTAzNzg4NzAwNDIVAgARGBI5NkFDMTQ4NDE5MTRDMDVGNzMA", "status": "read", "pricing": {"type": "regular", "billable": true, "category": "utility", "pricing_model": "PMP"}, "timestamp": "1787883150", "recipient_id": "50378870042", "recipient_user_id": "SV.3447949385373678"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-28 02:12:33.655
wamid.HBgLNTAzNzg4NzAwNDIVAgASGBQzQTc3NjRBOThCRjA4M0QzQzc3QgA=	whatsapp	{"entry": [{"id": "1904825813528568", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50378870042", "profile": {"name": "Lorraine Duarte"}, "user_id": "SV.3447949385373678"}], "messages": [{"id": "wamid.HBgLNTAzNzg4NzAwNDIVAgASGBQzQTc3NjRBOThCRjA4M0QzQzc3QgA=", "from": "50378870042", "type": "button", "button": {"text": "No, no podre asistir", "payload": "No, no podre asistir"}, "context": {"id": "wamid.HBgLNTAzNzg4NzAwNDIVAgARGBI5NkFDMTQ4NDE5MTRDMDVGNzMA", "from": "50378975033"}, "timestamp": "1787883155", "from_user_id": "SV.3447949385373678"}], "metadata": {"phone_number_id": "1191842234017105", "display_phone_number": "50378975033"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-28 02:12:36.598
wamid.HBgMNTk1OTgxNDAwODkwFQIAEhggQUM2NDNEQ0NCMjQwOTQyMzZEREMxMjM5REYxQjhDNzEA	whatsapp	{"entry": [{"id": "1904825813528568", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "595981400890", "profile": {"name": "MARIA ALEJANDRA MALUFF"}, "user_id": "PY.1750118786239148"}], "messages": [{"id": "wamid.HBgMNTk1OTgxNDAwODkwFQIAEhggQUM2NDNEQ0NCMjQwOTQyMzZEREMxMjM5REYxQjhDNzEA", "from": "595981400890", "text": {"body": "Hola como estas, finalmente no voy a poder asistir por temas laborales. Mil gracias."}, "type": "text", "timestamp": "1788128807", "from_user_id": "PY.1750118786239148"}], "metadata": {"phone_number_id": "1191842234017105", "display_phone_number": "50378975033"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-30 22:26:50.122
1767001538079280-1788137840-27fe5bec	whatsapp	{"entry": [{"id": "1767001538079280", "time": 1788137840, "changes": [{"field": "phone_number_name_update", "value": {"decision": "REJECTED", "rejection_reason": "BIZ_COMMERCE_VIOLATION_OTHER", "display_phone_number": "50368488314", "requested_verified_name": "RoofBall SV"}}]}], "object": "whatsapp_business_account"}	2026-08-31 00:57:22.269
wamid.HBgLNTAzNzU1ODI4NjAVAgASGBQzQTZEQUEyMDJBQkI2QzQwMzRBMAA=	whatsapp	{"entry": [{"id": "1410240457523724", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50375582860", "profile": {"name": "Gabriel Funes"}, "user_id": "SV.1369872035047009"}], "messages": [{"id": "wamid.HBgLNTAzNzU1ODI4NjAVAgASGBQzQTZEQUEyMDJBQkI2QzQwMzRBMAA=", "from": "50375582860", "text": {"body": "Hola"}, "type": "text", "timestamp": "1788211861", "from_user_id": "SV.1369872035047009"}], "metadata": {"phone_number_id": "1002474766287038", "display_phone_number": "50377070458"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-31 21:31:05.664
2178386092973067-1788217351-6c65a0aa	whatsapp	{"entry": [{"id": "2178386092973067", "time": 1788217351, "changes": [{"field": "account_update", "value": {"event": "PHONE_NUMBER_REMOVED", "phone_number": "50377124233"}}]}], "object": "whatsapp_business_account"}	2026-08-31 23:02:32.885
wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQUNDMjlDNzNDMzhGOURGQkEwOQA=	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "profile": {"name": "Sebastian R"}, "user_id": "SV.1725185398807266"}], "messages": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQUNDMjlDNzNDMzhGOURGQkEwOQA=", "from": "50360545592", "text": {"body": "Hola"}, "type": "text", "timestamp": "1788217510", "from_user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-31 23:05:13.818
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI5MjlGREE0MTdCOTZCQUQ4NDAA-sent	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI5MjlGREE0MTdCOTZCQUQ4NDAA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788217529", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-31 23:05:30.507
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI5MjlGREE0MTdCOTZCQUQ4NDAA-delivered	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI5MjlGREE0MTdCOTZCQUQ4NDAA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788217529", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-31 23:05:31.033
wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQTY1RTc2RUI1MzUzQjRFODM4RAA=	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "profile": {"name": "Sebastian R"}, "user_id": "SV.1725185398807266"}], "messages": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQTY1RTc2RUI1MzUzQjRFODM4RAA=", "from": "50360545592", "text": {"body": "Que espacios tiene esta semana"}, "type": "text", "timestamp": "1788217554", "from_user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-31 23:05:56.588
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBIwQTNCMTlEQUIxRDkwMjhFNEMA-sent	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBIwQTNCMTlEQUIxRDkwMjhFNEMA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788217573", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-31 23:06:13.897
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBIwQTNCMTlEQUIxRDkwMjhFNEMA-delivered	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBIwQTNCMTlEQUIxRDkwMjhFNEMA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788217573", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-31 23:06:14.301
wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQTk2ODM5QzVFQjZCMjRBRjdCMAA=	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "profile": {"name": "Sebastian R"}, "user_id": "SV.1725185398807266"}], "messages": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQTk2ODM5QzVFQjZCMjRBRjdCMAA=", "from": "50360545592", "text": {"body": "Cualquier dia"}, "type": "text", "timestamp": "1788217636", "from_user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-31 23:07:17.432
wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQTFEMjBGODg1RDMyMzZGRjA5RAA=	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "profile": {"name": "Sebastian R"}, "user_id": "SV.1725185398807266"}], "messages": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQTFEMjBGODg1RDMyMzZGRjA5RAA=", "from": "50360545592", "text": {"body": "Quiero saber que horarios hay cada dia"}, "type": "text", "timestamp": "1788217650", "from_user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-31 23:07:31.22
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI1QkZBQUM0NkYyQzMzMUMwNEEA-delivered	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI1QkZBQUM0NkYyQzMzMUMwNEEA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788217653", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-31 23:07:33.842
wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQTA2ODU1NkM1NjA1NzU5QUYzMQA=	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "profile": {"name": "Sebastian R"}, "user_id": "SV.1725185398807266"}], "messages": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQTA2ODU1NkM1NjA1NzU5QUYzMQA=", "from": "50360545592", "text": {"body": "Quiero saber que horarios hay libres esta semana. No tiene que ser las 7:15pm"}, "type": "text", "timestamp": "1788217605", "from_user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-31 23:06:46.08
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBJBMThBNEVENzgyMkVBQTU5RUEA-sent	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBJBMThBNEVENzgyMkVBQTU5RUEA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788217623", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-31 23:07:04.916
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI1QkZBQUM0NkYyQzMzMUMwNEEA-sent	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI1QkZBQUM0NkYyQzMzMUMwNEEA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788217652", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-31 23:07:33.895
wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQTMzMDdBODVDRkQ5MDJFQjU0RAA=	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "profile": {"name": "Sebastian R"}, "user_id": "SV.1725185398807266"}], "messages": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQTMzMDdBODVDRkQ5MDJFQjU0RAA=", "from": "50360545592", "text": {"body": "Lunes"}, "type": "text", "timestamp": "1788217663", "from_user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-31 23:07:44.396
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBJBMThBNEVENzgyMkVBQTU5RUEA-delivered	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBJBMThBNEVENzgyMkVBQTU5RUEA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788217624", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-31 23:07:04.768
wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQTE2MjJERDdBNjU1MjQxRTQxQwA=	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "profile": {"name": "Sebastian R"}, "user_id": "SV.1725185398807266"}], "messages": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQTE2MjJERDdBNjU1MjQxRTQxQwA=", "from": "50360545592", "text": {"body": "O miercoles"}, "type": "text", "timestamp": "1788217671", "from_user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-31 23:07:52.397
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBJBMEFFNkVGMUQ2QUYyMDBEOUYA-sent	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBJBMEFFNkVGMUQ2QUYyMDBEOUYA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788217689", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-31 23:08:10.009
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBJBMEFFNkVGMUQ2QUYyMDBEOUYA-delivered	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBJBMEFFNkVGMUQ2QUYyMDBEOUYA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788217689", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-31 23:08:10.134
wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQTU2MEIyRUUwODAxMkEzNDRFQQA=	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "profile": {"name": "Sebastian R"}, "user_id": "SV.1725185398807266"}], "messages": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQTU2MEIyRUUwODAxMkEzNDRFQQA=", "from": "50360545592", "text": {"body": "Trata otra vez"}, "type": "text", "timestamp": "1788217771", "from_user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-31 23:09:32.481
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI3M0U0MTA3QzMyQ0FFMjFCQUIA-sent	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI3M0U0MTA3QzMyQ0FFMjFCQUIA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788217790", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-31 23:09:51.199
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI3M0U0MTA3QzMyQ0FFMjFCQUIA-delivered	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI3M0U0MTA3QzMyQ0FFMjFCQUIA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788217790", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-08-31 23:09:51.351
wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQThBNzFFNjZFMjk2RUU3RjMxNwA=	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "profile": {"name": "Sebastian R"}, "user_id": "SV.1725185398807266"}], "messages": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQThBNzFFNjZFMjk2RUU3RjMxNwA=", "from": "50360545592", "text": {"body": "Hola"}, "type": "text", "timestamp": "1788285351", "from_user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-09-01 17:55:53.805
wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQTNCQ0NGQzc0NUEyMzI1M0ZDNQA=	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "profile": {"name": "Sebastian R"}, "user_id": "SV.1725185398807266"}], "messages": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQTNCQ0NGQzc0NUEyMzI1M0ZDNQA=", "from": "50360545592", "text": {"body": "Queria reservar cancha"}, "type": "text", "timestamp": "1788285355", "from_user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-09-01 17:55:56.199
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBJFMDk1Nzc1RTBGMTM2QjMxREQA-delivered	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBJFMDk1Nzc1RTBGMTM2QjMxREQA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788285370", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-09-01 17:56:11.982
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBJFMDk1Nzc1RTBGMTM2QjMxREQA-sent	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBJFMDk1Nzc1RTBGMTM2QjMxREQA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788285370", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-09-01 17:56:12.698
wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQTRGRTNBNTA2Mzk2MjU5QTY3NQA=	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "profile": {"name": "Sebastian R"}, "user_id": "SV.1725185398807266"}], "messages": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQTRGRTNBNTA2Mzk2MjU5QTY3NQA=", "from": "50360545592", "text": {"body": "Que espacios tienes este viernes"}, "type": "text", "timestamp": "1788285388", "from_user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-09-01 17:56:29.654
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI1NzQ4Q0M4NjcwRDhERUU2NDcA-sent	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI1NzQ4Q0M4NjcwRDhERUU2NDcA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788285406", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-09-01 17:56:47.681
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI1NzQ4Q0M4NjcwRDhERUU2NDcA-delivered	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI1NzQ4Q0M4NjcwRDhERUU2NDcA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788285407", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-09-01 17:56:48.36
wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQURGOEYzNUM3REMyNDIwNERGRQA=	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "profile": {"name": "Sebastian R"}, "user_id": "SV.1725185398807266"}], "messages": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQURGOEYzNUM3REMyNDIwNERGRQA=", "from": "50360545592", "text": {"body": "Pero que espacios tiene disponible"}, "type": "text", "timestamp": "1788285443", "from_user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-09-01 17:57:24.306
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBIyMEQ4Qzk0MkY2ODlBMzRDNDgA-delivered	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBIyMEQ4Qzk0MkY2ODlBMzRDNDgA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788285466", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-09-01 17:57:47.195
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBIyMEQ4Qzk0MkY2ODlBMzRDNDgA-sent	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBIyMEQ4Qzk0MkY2ODlBMzRDNDgA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788285466", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-09-01 17:57:47.349
wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQTEwRkEyRjVDRjQ4RDNBOThDQgA=	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "profile": {"name": "Sebastian R"}, "user_id": "SV.1725185398807266"}], "messages": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQTEwRkEyRjVDRjQ4RDNBOThDQgA=", "from": "50360545592", "text": {"body": "Quisiera 7pm"}, "type": "text", "timestamp": "1788285596", "from_user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-09-01 17:59:57.258
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI5RTUzNTVGOEY2NEYyRUYyNUUA-sent	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI5RTUzNTVGOEY2NEYyRUYyNUUA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788285616", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-09-01 18:00:17.965
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI5RTUzNTVGOEY2NEYyRUYyNUUA-delivered	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBI5RTUzNTVGOEY2NEYyRUYyNUUA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788285617", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-09-01 18:00:17.973
wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQUI0MTFCODNFMTAwMkE3RTI5OAA=	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "profile": {"name": "Sebastian R"}, "user_id": "SV.1725185398807266"}], "messages": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgASGBQzQUI0MTFCODNFMTAwMkE3RTI5OAA=", "from": "50360545592", "text": {"body": "Seria sebastian recinos"}, "type": "text", "timestamp": "1788285635", "from_user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-09-01 18:00:37.009
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBIyNTI1OEVDNjA0MTExNjk2NDkA-sent	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBIyNTI1OEVDNjA0MTExNjk2NDkA", "status": "sent", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788285660", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-09-01 18:01:01.282
wamid.HBgLNTAzNjA1NDU1OTIVAgARGBIyNTI1OEVDNjA0MTExNjk2NDkA-delivered	whatsapp	{"entry": [{"id": "1767001538079280", "changes": [{"field": "messages", "value": {"contacts": [{"wa_id": "50360545592", "user_id": "SV.1725185398807266"}], "metadata": {"phone_number_id": "1307992975727019", "display_phone_number": "50368488314"}, "statuses": [{"id": "wamid.HBgLNTAzNjA1NDU1OTIVAgARGBIyNTI1OEVDNjA0MTExNjk2NDkA", "status": "delivered", "pricing": {"type": "free_customer_service", "billable": false, "category": "service", "pricing_model": "PMP"}, "timestamp": "1788285660", "recipient_id": "50360545592", "recipient_user_id": "SV.1725185398807266"}], "messaging_product": "whatsapp"}}]}], "object": "whatsapp_business_account"}	2026-09-01 18:01:01.601
\.
...
campaign-media	campaign-media	\N	2026-04-15 23:29:00.052422+00	2026-04-15 23:29:00.052422+00	t	f	\N	{image/jpeg,image/png,image/webp}	\N	STANDARD	DISABLED
media	media	\N	2026-04-16 16:57:37.593735+00	2026-04-16 16:57:37.593735+00	t	f	20971520	\N	\N	STANDARD	DISABLED
abita-assets	abita-assets	\N	2026-08-27 18:30:15.851569+00	2026-08-27 18:30:15.851569+00	t	f	\N	\N	\N	STANDARD	DISABLED
\.
...
62	object-versioning-core	0b855f00ff3be0bfca91efee02a9858912491a9a	2026-08-21 00:06:58.846924
63	fix-search-name-relative-to-prefix	c7485e417624f795ce8bb2da21927f48e088904d	2026-08-23 03:45:11.255851
64	fix-search-by-timestamp-sqli	0af424ecd388a39bb1645184b222185a12149675	2026-08-23 03:45:11.312227
\.
...
4ac930d5-3331-48f3-a813-28da3a17c414	campaign-media	campaigns/8azl6c81wnm.png	\N	2026-04-15 23:29:01.2435+00	2026-04-15 23:29:01.2435+00	2026-04-15 23:29:01.2435+00	{"eTag": "\\"42c5132ef7642b03ff8ac71b30c8f29e\\"", "size": 523551, "mimetype": "image/png", "cacheControl": "max-age=3600", "lastModified": "2026-04-15T23:29:02.000Z", "contentLength": 523551, "httpStatusCode": 200}	8cd52efa-72af-4ed5-a15e-fe62687cfd16	\N	{}	\N	f	f
fc3af938-7b90-40d3-b293-032c11b601c1	media	uploads/1c5a20bb-2da9-4b38-8fe3-e1cbd8acd205-WhatsApp_Image_2026-04-15_at_5.34.08_PM.jpeg	\N	2026-07-06 23:37:00.807824+00	2026-07-06 23:37:00.807824+00	2026-07-06 23:37:00.807824+00	{"eTag": "\\"9a3eda557ec5b1e02dcf2fb57f42412d\\"", "size": 95861, "mimetype": "image/jpeg", "cacheControl": "max-age=3600", "lastModified": "2026-07-06T23:37:01.000Z", "contentLength": 95861, "httpStatusCode": 200}	ea41d96b-237d-477d-b23b-45ccdaf0b473	\N	{}	\N	f	f
5f8b38b6-ca10-4112-97f7-1268fb12b06f	campaign-media	campaigns/xdipcsgt1j.png	\N	2026-04-15 23:30:48.548986+00	2026-04-15 23:30:48.548986+00	2026-04-15 23:30:48.548986+00	{"eTag": "\\"42c5132ef7642b03ff8ac71b30c8f29e\\"", "size": 523551, "mimetype": "image/png", "cacheControl": "max-age=3600", "lastModified": "2026-04-15T23:30:49.000Z", "contentLength": 523551, "httpStatusCode": 200}	1d8ee376-328a-495e-9bf0-4657ae471640	\N	{}	\N	f	f
25e274c0-00c6-49c5-837b-66824d87b8ec	campaign-media	campaigns/eerk8cph9gj.png	\N	2026-04-15 23:37:22.893026+00	2026-04-15 23:37:22.893026+00	2026-04-15 23:37:22.893026+00	{"eTag": "\\"f0f9639a58f3df5c86211d0bd916cd50\\"", "size": 821955, "mimetype": "image/png", "cacheControl": "max-age=3600", "lastModified": "2026-04-15T23:37:23.000Z", "contentLength": 821955, "httpStatusCode": 200}	0b953d12-d620-4ee2-a3a0-7aa292d219f8	\N	{}	\N	f	f
...
b5d6f230-6c45-48ed-b183-93649ce61238	media	uploads/a40ebe82-5e24-4dcc-945a-fc25ca397afc-adjunto.jpeg	\N	2026-08-21 00:06:57.983985+00	2026-08-21 00:06:57.983985+00	2026-08-21 00:06:57.983985+00	{"eTag": "\\"330746846c85ecb99e862c2eb814e2fb\\"", "size": 16661, "mimetype": "image/jpeg", "cacheControl": "max-age=3600", "lastModified": "2026-08-21T00:06:58.000Z", "contentLength": 16661, "httpStatusCode": 200}	f28a2e78-b0ec-41f3-98ff-db578d0848c8	\N	{}	\N	f	f
54a1a8a5-ba37-43c0-a4a7-c2b34076ad38	media	uploads/029f9b5d-b378-4717-8578-355b56478e6b-voice-note-1787362270755.webm	\N	2026-08-22 01:31:11.232817+00	2026-08-22 01:31:11.232817+00	2026-08-22 01:31:11.232817+00	{"eTag": "\\"9c79f37e707be22cbb328cb39a8285b0\\"", "size": 30258, "mimetype": "audio/webm", "cacheControl": "max-age=3600", "lastModified": "2026-08-22T01:31:12.000Z", "contentLength": 30258, "httpStatusCode": 200}	2eb1bfc4-ca90-45e5-b483-92d5f9ebbfc5	\N	{}	\N	f	f
40f09466-351f-491e-bc48-a6f54fff0380	media	uploads/02c34fdb-3920-4c4b-8e49-f2c490eea3c8-voice-note-1787362720112.mp4	\N	2026-08-22 01:38:40.569852+00	2026-08-22 01:38:40.569852+00	2026-08-22 01:38:40.569852+00	{"eTag": "\\"5d41fcd40d5e182f82354b376593370d\\"", "size": 19062, "mimetype": "audio/mp4", "cacheControl": "max-age=3600", "lastModified": "2026-08-22T01:38:41.000Z", "contentLength": 19062, "httpStatusCode": 200}	9e1c2b28-1ad6-43c6-a459-1321dad0468e	\N	{}	\N	f	f
02b92fe7-5110-479b-8819-2f88ed8aa633	media	uploads/610b0278-c2a7-4658-87be-93b834a59554-voice-note-1787363187140.mp4	\N	2026-08-22 01:46:27.481066+00	2026-08-22 01:46:27.481066+00	2026-08-22 01:46:27.481066+00	{"eTag": "\\"8edfc2a7aad1f9c37c3a9cc51e5ee8f3\\"", "size": 16445, "mimetype": "audio/mp4", "cacheControl": "max-age=3600", "lastModified": "2026-08-22T01:46:28.000Z", "contentLength": 16445, "httpStatusCode": 200}	b97fae8b-1b28-4883-852b-f45986340245	\N	{}	\N	f	f
80ba8bd7-dbee-4bc9-92cc-311c8bbaab48	media	uploads/156a58f6-c82a-46e2-b4b2-d98f5b41ef01-voice-note-1787363668079.mp4	\N	2026-08-22 01:54:28.689978+00	2026-08-22 01:54:28.689978+00	2026-08-22 01:54:28.689978+00	{"eTag": "\\"d2e02fc717348f45e87931d16135d814\\"", "size": 20009, "mimetype": "audio/mp4", "cacheControl": "max-age=3600", "lastModified": "2026-08-22T01:54:29.000Z", "contentLength": 20009, "httpStatusCode": 200}	8c0005de-d66a-45f5-8dec-1bc76e839121	\N	{}	\N	f	f
41bc48cc-4a5a-4178-ab39-a16b0e9ac51a	media	uploads/263c32e9-891a-4ada-b766-ed434aae1456-voice-note-1787363926990.mp4	\N	2026-08-22 01:58:47.534066+00	2026-08-22 01:58:47.534066+00	2026-08-22 01:58:47.534066+00	{"eTag": "\\"996fbe30435a97baafe0e9cb734e996d\\"", "size": 28005, "mimetype": "audio/mp4", "cacheControl": "max-age=3600", "lastModified": "2026-08-22T01:58:48.000Z", "contentLength": 28005, "httpStatusCode": 200}	f8bc6023-7dfa-4d3c-b265-ac07e89f35e6	\N	{}	\N	f	f
bc279cac-dc49-4276-b806-89f14a6f100a	media	uploads/19539f96-152a-4ea7-a09e-bed2ce4cac81-voice-note-1787365163579.ogg	\N	2026-08-22 02:19:24.65731+00	2026-08-22 02:19:24.65731+00	2026-08-22 02:19:24.65731+00	{"eTag": "\\"300a96e7ece4d97044b0d8d4d759f02e\\"", "size": 17401, "mimetype": "audio/ogg", "cacheControl": "max-age=3600", "lastModified": "2026-08-22T02:19:25.000Z", "contentLength": 17401, "httpStatusCode": 200}	0b41b9a2-6c2b-4e60-8c7b-1146f60956e4	\N	{}	\N	f	f
a4ee1268-bc5a-40a4-a593-cc205bd2b429	media	uploads/d78343f1-5d64-4129-a0fb-cfaf4d14f090-voice-note-1787366181845.ogg	\N	2026-08-22 02:36:22.671973+00	2026-08-22 02:36:22.671973+00	2026-08-22 02:36:22.671973+00	{"eTag": "\\"c3ec4b8216c510b28166e38160a99119\\"", "size": 8002, "mimetype": "audio/ogg", "cacheControl": "max-age=3600", "lastModified": "2026-08-22T02:36:23.000Z", "contentLength": 8002, "httpStatusCode": 200}	be76c1c5-6685-43a7-89ac-b3efaa17a795	\N	{}	\N	f	f
6079db62-a171-4b2f-b2b3-989587c7846d	media	uploads/3a14f3d5-8451-4cd0-aa0e-9fb9c1859a80-voice-note-1787428552859.ogg	\N	2026-08-22 19:55:53.92122+00	2026-08-22 19:55:53.92122+00	2026-08-22 19:55:53.92122+00	{"eTag": "\\"e36fee9cb5293c82070df6bc61a813ae\\"", "size": 8698, "mimetype": "audio/ogg", "cacheControl": "max-age=3600", "lastModified": "2026-08-22T19:55:54.000Z", "contentLength": 8698, "httpStatusCode": 200}	7be63fb2-72f2-4b0d-ba14-70e9719f1125	\N	{}	\N	f	f
4cecc041-00f1-4064-85bb-9f140c23d3c4	media	uploads/51af3ab3-b53c-4770-afb8-056d6bae5b1e-voice-note-1787429089239.ogg	\N	2026-08-22 20:04:51.669838+00	2026-08-22 20:04:51.669838+00	2026-08-22 20:04:51.669838+00	{"eTag": "\\"37141125b03b7e96732201d195402c2d\\"", "size": 8520, "mimetype": "audio/ogg", "cacheControl": "max-age=3600", "lastModified": "2026-08-22T20:04:52.000Z", "contentLength": 8520, "httpStatusCode": 200}	9c4986a9-3ceb-4444-82b0-9d4bd331fe62	\N	{}	\N	f	f
f1ccfafa-a493-4c2e-b6d4-9a30d6a02b1d	media	uploads/be0ed0e9-7059-4f84-964a-dc17ba0f4ff0-adjunto.ogg	\N	2026-08-22 20:08:23.596336+00	2026-08-22 20:08:23.596336+00	2026-08-22 20:08:23.596336+00	{"eTag": "\\"62243efb46ec9f58a8bec017108286fc\\"", "size": 6028, "mimetype": "audio/ogg", "cacheControl": "max-age=3600", "lastModified": "2026-08-22T20:08:24.000Z", "contentLength": 6028, "httpStatusCode": 200}	00b99c3c-83e2-4e51-8f1a-eb294e66ef47	\N	{}	\N	f	f
53d17a78-9f9a-4167-a605-00d86356f1bb	media	uploads/070a6825-d4aa-4d7d-b541-17bd4b8efca3-voice-note-1787430023173.ogg	\N	2026-08-22 20:20:25.259031+00	2026-08-22 20:20:25.259031+00	2026-08-22 20:20:25.259031+00	{"eTag": "\\"9a82e776fa84b0f4a3f26df1a85ebfa9\\"", "size": 24723, "mimetype": "audio/ogg", "cacheControl": "max-age=3600", "lastModified": "2026-08-22T20:20:26.000Z", "contentLength": 24723, "httpStatusCode": 200}	574d3586-e336-457a-b025-85d6061eeaf5	\N	{}	\N	f	f
61a51eee-cfef-47dd-9a79-c1e42cf2f43c	media	uploads/c4528505-d763-4def-8b47-1c1f46e4325b-adjunto.webp	\N	2026-08-23 03:45:07.064071+00	2026-08-23 03:45:07.064071+00	2026-08-23 03:45:07.064071+00	{"eTag": "\\"06d9a925a29a15b195d6398f34188a76\\"", "size": 297394, "mimetype": "image/webp", "cacheControl": "max-age=3600", "lastModified": "2026-08-23T03:45:08.000Z", "contentLength": 297394, "httpStatusCode": 200}	b84a3e8e-ca42-441f-b7a6-2ca5d8b200e2	\N	{}	\N	f	f
5565a0c9-54c3-4e07-aa97-632b6a71c409	media	uploads/d20c2a16-6ec4-4987-88a8-389beea88cb2-adjunto.webp	\N	2026-08-23 03:56:15.362859+00	2026-08-23 03:56:15.362859+00	2026-08-23 03:56:15.362859+00	{"eTag": "\\"04d4d40bbdcb916f9efec6ca4d4296f1\\"", "size": 483078, "mimetype": "image/webp", "cacheControl": "max-age=3600", "lastModified": "2026-08-23T03:56:16.000Z", "contentLength": 483078, "httpStatusCode": 200}	999da4bd-cb8d-4bfc-a1c0-0d1ce139dc5b	\N	{}	\N	f	f
e4851f49-bbf4-49e7-8bf5-729e2817bdce	media	uploads/02a6ac49-3aa1-4fb2-b59c-f974dc0fdb8f-voice-note-1787538970106.ogg	\N	2026-08-24 02:36:11.37338+00	2026-08-24 02:36:11.37338+00	2026-08-24 02:36:11.37338+00	{"eTag": "\\"2f3c89d37185fa91093157454c2192e0\\"", "size": 7083, "mimetype": "audio/ogg", "cacheControl": "max-age=3600", "lastModified": "2026-08-24T02:36:12.000Z", "contentLength": 7083, "httpStatusCode": 200}	511648d6-30c5-4b8e-b88c-067e5127645c	\N	{}	\N	f	f
fdc7f3b9-0707-4de3-8382-4ae4ad2808fd	media	uploads/bb649520-2485-407e-87d7-f37a7333b7c0-voice-note-1787539561561.ogg	\N	2026-08-24 02:46:02.445645+00	2026-08-24 02:46:02.445645+00	2026-08-24 02:46:02.445645+00	{"eTag": "\\"246f7fb72916365c19d6a6c9fc3ebd6e\\"", "size": 5590, "mimetype": "audio/ogg", "cacheControl": "max-age=3600", "lastModified": "2026-08-24T02:46:03.000Z", "contentLength": 5590, "httpStatusCode": 200}	c63f3b0c-675b-46af-8dbc-69b710691b5a	\N	{}	\N	f	f
\.
...
--
-- Name: PushSubscription PushSubscription_clientId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."PushSubscription"
    ADD CONSTRAINT "PushSubscription_clientId_fkey" FOREIGN KEY ("clientId") REFERENCES "public"."Client"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
\unrestrict ZDAAubdiIQVpLGU29vyYMKvfwQSElxab0uiRP6KPcPssZmHuepDpxCwjXGJYO8I
